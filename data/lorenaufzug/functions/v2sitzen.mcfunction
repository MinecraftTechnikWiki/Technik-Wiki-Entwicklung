...
execute if entity @s[tag=EtiLoAuf.2Fahren] unless entity @e[distance=..1,type=minecraft:interaction,tag=EtiLoAuf.2Sitzen,sort=nearest,limit=1] run summon minecraft:interaction ~ ~ ~ {Tags:["EtiLoAuf.2Alle","EtiLoAuf.2Sitzen"]}
ride @s[tag=EtiLoAuf.2Fahren] mount @e[distance=..1,type=minecraft:interaction,tag=EtiLoAuf.2Sitzen,sort=nearest,limit=1]
execute if entity @s[tag=!EtiLoAuf.2Fahren] on vehicle run kill @s

data modify entity @e[distance=..1,type=minecraft:interaction,tag=EtiLoAuf.2Sitzen,sort=nearest,limit=1] Tags append from entity @s Tags[]
