...
clear @a minecraft:minecart[minecraft:custom_data={EigLoAuf.2Alle:true}]
...
execute as @e[type=minecraft:item] unless entity @s[nbt=!{Item:{components:{"minecraft:custom_data":{EigLoAuf.2Alle:true} } } },nbt=!{Item:{components:{"minecraft:custom_name":{bold:true,color:"dark_purple",text:"Lorenaufzug-Lore"} } } }] run kill @s
