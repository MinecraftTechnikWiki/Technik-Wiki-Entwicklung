...
#execute at @e[type=minecraft:armor_stand,tag=EtiLoAuf.2Start] run tag @n[distance=..1,type=minecraft:minecart,tag=!EtiLoAuf.2Hoch] add EtiLoAuf.2Hoch
#execute as @e[type=minecraft:minecart,tag=EtiLoAuf.2Hoch] at @s run teleport @s ^ ^0.5 ^ facing entity @n[type=minecraft:armor_stand,tag=EtiLoAuf.2Ziel]
#execute at @e[type=minecraft:armor_stand,tag=EtiLoAuf.2Ziel] positioned ~ ~1 ~ run tag @n[distance=..2,type=minecraft:minecart,tag=EtiLoAuf.2Hoch] remove EtiLoAuf.2Hoch
