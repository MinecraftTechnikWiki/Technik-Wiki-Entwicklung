...
execute at @n[type=minecraft:text_display,tag=EtiSkyWaMS.1Teleporter] run fill ~-8 ~-3 ~-8 ~8 ~15 ~8 minecraft:air replace
...
execute at @n[type=minecraft:interaction,tag=EtiSkyWaMS.1Wartesaal] run fill ~-11 ~-1 ~-11 ~11 ~6 ~11 minecraft:air replace
...
execute at @n[type=minecraft:text_display,tag=EtiSkyWaMS.1Teleporter] positioned ~-10 ~-4 ~-10 run kill @e[dx=20,dy=20,dz=20,type=minecraft:item]
