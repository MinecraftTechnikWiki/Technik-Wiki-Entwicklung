...
execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Spielfeld,sort=nearest,limit=1] run clear @a[distance=..100,tag=EtiBoSplMS.1Spielen] minecraft:bow[minecraft:custom_data~{EigBoSplMS.1Alle:true}]
execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Spielfeld,sort=nearest,limit=1] run clear @a[distance=..100,tag=EtiBoSplMS.1Spielen] minecraft:arrow[minecraft:custom_data~{EigBoSplMS.1Alle:true}]
...
execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Ebene,sort=nearest,limit=1] run place template bow-spleef-minispiel:v1ebene ~ ~ ~ none
execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Ebene,sort=nearest,limit=1] run place template bow-spleef-minispiel:v1ebene ~ ~ ~ clockwise_90
execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Ebene,sort=nearest,limit=1] run place template bow-spleef-minispiel:v1ebene ~ ~ ~ 180
execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Ebene,sort=nearest,limit=1] run place template bow-spleef-minispiel:v1ebene ~ ~ ~ counterclockwise_90
