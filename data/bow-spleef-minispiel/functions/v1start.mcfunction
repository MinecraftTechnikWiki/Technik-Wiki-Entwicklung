...
summon minecraft:area_effect_cloud ~ ~ ~ {Duration:400,Tags:["EtiBoSplMS.1Start"]}
...
execute at @e[type=minecraft:text_display,tag=EtiBoSplMS.1Teleporter,sort=nearest,limit=1] run place template bow-spleef-minispiel:v1teleporter ~-8 ~-3 ~-9 none

summon minecraft:marker ~ ~ ~-50 {Tags:["EtiBoSplMS.1Alle","EtiBoSplMS.1Spielfeld"]}
execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Spielfeld,sort=nearest,limit=1] run place template bow-spleef-minispiel:v1gebiet ~ ~ ~ none
execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Spielfeld,sort=nearest,limit=1] run place template bow-spleef-minispiel:v1gebiet ~ ~ ~ clockwise_90
execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Spielfeld,sort=nearest,limit=1] run place template bow-spleef-minispiel:v1gebiet ~ ~ ~ 180
execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Spielfeld,sort=nearest,limit=1] run place template bow-spleef-minispiel:v1gebiet ~ ~ ~ counterclockwise_90

execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Spielfeld,sort=nearest,limit=1] run summon minecraft:marker ~ ~4 ~ {Tags:["EtiBoSplMS.1Alle","EtiBoSplMS.1Ebene"]}

execute as @e[type=minecraft:marker,tag=EtiBoSplMS.1Spielfeld,sort=nearest,limit=1] store result score @s PZBoSplMS.1Wert run data get entity @s Pos[1]
execute as @e[type=minecraft:marker,tag=EtiBoSplMS.1Spielfeld,sort=nearest,limit=1] store result entity @s data."EigBoSplMS.1Argumente".Y int 1 run scoreboard players add @s PZBoSplMS.1Wert 10

execute at @e[type=minecraft:marker,tag=EtiBoSplMS.1Spielfeld,sort=nearest,limit=1] run summon minecraft:interaction ~ ~15.5 ~ {width:52,height:3,Tags:["EtiBoSplMS.1Alle","EtiBoSplMS.1Wartesaal"]}
