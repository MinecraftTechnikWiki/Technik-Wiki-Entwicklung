...
give @a[distance=..25] minecraft:armor_stand{EigGlBW.1Alle:true,display:{Name:'{"text":"Gleisbettwandler"}',Lore:['"Platziere den Rüstungsständer"','"um den Gleisbettwandler zu erstellen"']},EntityTag:{Invisible:true,Small:true,NoGravity:true,CustomNameVisible:true,CustomName:'{"text":"Gleisbettwandler"}',Tags:["EtiGlBW.1Alle","EtiGlBW.1Wandler","EtiGlBW.1Erstellen"],ArmorItems:[{},{},{},{id:"minecraft:magenta_glazed_terracotta",Count:1b} ],Pose:{Head:[0f,0f,180f] } } } 1

give @p[distance=..25] minecraft:andesite{EigGlBW.1Alle:true} 1
give @p[distance=..25] minecraft:diorite{EigGlBW.1Alle:true} 1
give @p[distance=..25] minecraft:granite{EigGlBW.1Alle:true} 1
give @p[distance=..25] minecraft:gravel{EigGlBW.1Alle:true} 1
