...
summon minecraft:armor_stand ^ ^2 ^1 {Small:true,Invisible:true,NoGravity:true,CustomNameVisible:true,CustomName:{text:"Bearbeiter",color:"gold",bold:true},Tags:["EtiTuriM.1Alle","EtiTuriM.1LeseSchreibKopf"],equipment:{head:{id:"minecraft:observer",count:1} } }
