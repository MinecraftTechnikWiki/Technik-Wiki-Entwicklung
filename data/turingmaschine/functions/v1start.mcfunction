...
give @a[distance=..15] minecraft:armor_stand{EigTuriM.1Alle:true,display:{Name:'{"text":"Turingmaschine","color":"green","bold":true}',Lore:['"Platziere den Rüstungsständer"','"um die Maschine zu erzeugen"']},EntityTag:{Small:true,Marker:true,Invisible:true,CustomNameVisible:true,CustomName:'{"text":"Turingmaschine","color":"green","bold":true}',Tags:["EtiTuriM.1Alle","EtiTuriM.1Turingmaschine","EtiTuriM.1Erstellen"] } }
