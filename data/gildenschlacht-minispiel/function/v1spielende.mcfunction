...
execute at @n[type=minecraft:marker,tag=EtiGildSMS.1Spielfeld] run effect give @a[distance=..100,tag=EtiGildSMS.1Spielen] minecraft:resistance infinite 10 true
execute at @n[type=minecraft:marker,tag=EtiGildSMS.1Spielfeld] run effect give @a[distance=..100,tag=EtiGildSMS.1Spielen] minecraft:instant_health infinite 10 true
