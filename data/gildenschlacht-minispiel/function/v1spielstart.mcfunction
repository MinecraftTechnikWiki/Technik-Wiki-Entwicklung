...
$execute at @n[type=minecraft:marker,tag=EtiGildSMS.1Team1] positioned ~ ~ ~ run spreadplayers ~ ~ 1 2 under $(Y) false @a[distance=..50,team=TMGildSMS.1Team1]
$execute at @n[type=minecraft:marker,tag=EtiGildSMS.1Team2] positioned ~ ~ ~ run spreadplayers ~ ~ 1 2 under $(Y) false @a[distance=..50,team=TMGildSMS.1Team2]
