...
execute if score VarGildSMS.1Ungerade PZGildSMS.1Wert matches 1 if score VarGildSMS.1Zufallszahl PZGildSMS.1Wert matches 1 run attribute @r[team=TMGildSMS.1Team1] minecraft:generic.max_health base set 40
execute if score VarGildSMS.1Ungerade PZGildSMS.1Wert matches 1 if score VarGildSMS.1Zufallszahl PZGildSMS.1Wert matches 0 run attribute @r[team=TMGildSMS.1Team2] minecraft:generic.max_health base set 40

# Spieler in den beiden Teams erhalten im Kopfslot einen farbenen Helm mit der Mannschaftsfarbe.
item replace entity @a[team=TMGildSMS.1Team1] armor.head with minecraft:leather_helmet[minecraft:enchantments={levels:{"minecraft:binding_curse":1} },minecraft:custom_data={EigGildSMS.1Alle:true},minecraft:dyed_color={rgb:16711680}]
item replace entity @a[team=TMGildSMS.1Team2] armor.head with minecraft:leather_helmet[minecraft:enchantments={levels:{"minecraft:binding_curse":1} },minecraft:custom_data={EigGildSMS.1Alle:true},minecraft:dyed_color={rgb:255}]
