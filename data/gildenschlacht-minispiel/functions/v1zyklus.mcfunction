...
execute at @e[type=minecraft:text_display,tag=EtiGildSMS.1Teleporter,sort=nearest,limit=1] run particle minecraft:portal ~ ~-3 ~ 0 1 0 0.7 35 force @a[distance=..15]

execute if score VarGildSMS.1Teilnehmer PZGildSMS.1Wert matches 10 at @e[type=minecraft:text_display,tag=EtiGildSMS.1Teleporter,sort=nearest,limit=1] positioned ~ ~-3 ~ run title @a[distance=..3] actionbar ["",{"text":"Lobby ist voll","color":"red","bold":true}]
execute if score VarGildSMS.1Teilnehmer PZGildSMS.1Wert matches ..9 at @e[type=minecraft:text_display,tag=EtiGildSMS.1Teleporter,sort=nearest,limit=1] positioned ~ ~-3 ~ as @p[distance=..3,gamemode=!spectator] run function gildenschlacht-minispiel:v1beitreten

execute if score VarGildSMS.1Wartende PZGildSMS.1Wert matches 1.. as @e[type=minecraft:interaction,tag=EtiGildSMS.1Wartesaal,sort=nearest,limit=1] store success score @s PZGildSMS.1Wert if data entity @s interaction
execute if score VarGildSMS.1Wartende PZGildSMS.1Wert matches 1.. as @e[type=minecraft:interaction,tag=EtiGildSMS.1Wartesaal,scores={PZGildSMS.1Wert=1},sort=nearest,limit=1] on target run tag @s[team=TMGildSMS.1Lobby,nbt={SelectedItem:{id:"minecraft:red_bed",components:{"minecraft:custom_data":{EigGildSMS.1Verlassen:true} } } }] add EtiGildSMS.1Verlassen
execute if score VarGildSMS.1Wartende PZGildSMS.1Wert matches 1.. run data remove entity @e[type=minecraft:interaction,tag=EtiGildSMS.1Wartesaal,scores={PZGildSMS.1Wert=1},sort=nearest,limit=1] interaction
...
execute if score VarGildSMS.1Spielende PZGildSMS.1Wert matches 0 at @e[type=minecraft:marker,tag=EtiGildSMS.1Spielfeld,sort=nearest,limit=1] as @a[distance=..100,tag=EtiGildSMS.1Spielen,tag=!EtiGildSMS.1Verloren] at @s run function gildenschlacht-minispiel:v1spielen
...
execute at @e[type=minecraft:marker,tag=EtiGildSMS.1Spielfeld,sort=nearest,limit=1] as @a[distance=100..,tag=EtiGildSMS.1Spielen,scores={PZGildSMS.1Sterben=1..}] run function gildenschlacht-minispiel:v1verloren

execute at @e[type=minecraft:marker,tag=EtiGildSMS.1Spielfeld,sort=nearest,limit=1] as @a[distance=..100,team=!] unless entity @s[team=!TMGildSMS.1Lobby,tag=!EtiGildSMS.1Spielen] positioned ~-25 ~-1 ~-25 unless entity @s[dx=50,dy=40,dz=50] run function gildenschlacht-minispiel:v1verlassen

execute at @e[type=minecraft:marker,tag=EtiGildSMS.1Spielfeld,sort=nearest,limit=1] as @a[distance=..100,team=!TMGildSMS.1Lobby,tag=!EtiGildSMS.1Spielen] positioned ~-25 ~-1 ~-25 if entity @s[dx=50,dy=40,dz=50] run function gildenschlacht-minispiel:v1verlassen
...
data modify entity @e[distance=..15,type=minecraft:text_display,tag=EtiGildSMS.1Teleporter,sort=nearest,limit=1] text set value '["",{"text":"Lobby","color":"yellow","bold":true},"\\n",{"score":{"name":"VarGildSMS.1Teilnehmer","objective":"PZGildSMS.1Wert"},"color":"dark_purple","bold":true},{"text":"/","bold":true},{"text":"10","color":"dark_purple","bold":true}]'

execute if score VarGildSMS.1Wartende PZGildSMS.1Wert matches 1.. as @e[type=minecraft:interaction,tag=EtiGildSMS.1Wartesaal,sort=nearest,limit=1] at @s run function gildenschlacht-minispiel:v1warten

execute if score VarGildSMS.1Zaehlen PZGildSMS.1Wert matches 1 at @e[type=minecraft:interaction,tag=EtiGildSMS.1Wartesaal,sort=nearest,limit=1] as @e[type=minecraft:marker,tag=EtiGildSMS.1Spielfeld,sort=nearest,limit=1] run function gildenschlacht-minispiel:v1spielstart with entity @s data."EigGildSMS.1Argumente"

execute if score VarGildSMS.1Spielen PZGildSMS.1Wert matches 1 if score VarGildSMS.1Spielende PZGildSMS.1Wert matches 1 at @e[type=minecraft:marker,tag=EtiGildSMS.1Spielfeld,sort=nearest,limit=1] run function gildenschlacht-minispiel:v1spielende
