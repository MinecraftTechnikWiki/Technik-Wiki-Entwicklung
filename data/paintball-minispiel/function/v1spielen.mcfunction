...
execute positioned ~-4 ~-1 ~-4 if score @s PZPaintBMS.1Wert = @n[dx=8,dy=32,dz=8,type=minecraft:interaction,tag=EtiPaintBMS.1Startpunkt] PZPaintBMS.1Wert run tag @s add EtiPaintBMS.1Nachschub
