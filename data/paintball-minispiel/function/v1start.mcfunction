...
summon minecraft:area_effect_cloud ~ ~ ~ {Duration:400,custom_particle:{type:"minecraft:block",block_state:"minecraft:air"},Radius:0.0f,Tags:["EtiPaintBMS.1Start"]}
...
execute at @n[type=minecraft:text_display,tag=EtiPaintBMS.1Teleporter] run place template paintball-minispiel:v1teleporter ~-8 ~-3 ~-9 none

summon minecraft:marker ~ ~ ~-50 {Tags:["EtiPaintBMS.1Alle","EtiPaintBMS.1Spielfeld"]}
execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] run place template paintball-minispiel:v1gebiet1 ~ ~ ~ none
execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] run place template paintball-minispiel:v1gebiet2 ~-1 ~ ~1 clockwise_90
execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] run place template paintball-minispiel:v1gebiet1 ~ ~ ~ 180
execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] run place template paintball-minispiel:v1gebiet2 ~1 ~ ~-1 counterclockwise_90

execute as @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] store result score @s PZPaintBMS.1Wert run data get entity @s Pos[1]
execute as @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] store result entity @s data."EigPaintBMS.1Argumente".Y int 1 run scoreboard players add @s PZPaintBMS.1Wert 10

execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] run summon minecraft:interaction ~20 ~ ~15 {width:8,height:16,Tags:["EtiPaintBMS.1Alle","EtiPaintBMS.1Startpunkt"]}
scoreboard players set @n[type=minecraft:interaction,tag=EtiPaintBMS.1Startpunkt] PZPaintBMS.1Wert 1
...
execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] run summon minecraft:interaction ~ ~35.5 ~ {width:21,height:3,Tags:["EtiPaintBMS.1Alle","EtiPaintBMS.1Wartesaal"]}
execute at @n[type=minecraft:interaction,tag=EtiPaintBMS.1Wartesaal] run place template paintball-minispiel:v1wartesaal ~-11 ~-1 ~-11 none

execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] positioned ~-30 ~-1 ~-30 as @a[dx=60,dy=40,dz=60] at @s run function paintball-minispiel:v1verlassen
