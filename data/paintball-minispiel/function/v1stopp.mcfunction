...
execute at @n[type=minecraft:text_display,tag=EtiPaintBMS.1Teleporter] run fill ~-8 ~-3 ~-8 ~8 ~15 ~8 minecraft:air replace

execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] run fill ~ ~ ~ ~31 ~31 ~31 minecraft:air replace
execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] run fill ~ ~ ~ ~-31 ~31 ~31 minecraft:air replace
execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] run fill ~ ~ ~ ~31 ~31 ~-31 minecraft:air replace
execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] run fill ~ ~ ~ ~-31 ~31 ~-31 minecraft:air replace

execute at @n[type=minecraft:interaction,tag=EtiPaintBMS.1Wartesaal] run fill ~-11 ~-1 ~-11 ~11 ~6 ~11 minecraft:air replace
...
execute at @n[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld] positioned ~-40 ~-1 ~-40 run kill @e[dx=80,dy=40,dz=80,type=minecraft:item]

execute at @n[type=minecraft:text_display,tag=EtiPaintBMS.1Teleporter] positioned ~-10 ~-4 ~-10 run kill @e[dx=20,dy=20,dz=20,type=minecraft:item]
