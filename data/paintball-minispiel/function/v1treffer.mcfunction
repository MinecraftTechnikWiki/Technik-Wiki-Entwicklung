...
execute if score @n[distance=..0.2,type=minecraft:marker,tag=EtiPaintBMS.1Paintball,scores={PZPaintBMS.1Wert=1..}] PZPaintBMS.1Wert = @s PZPaintBMS.1Wert run return 0

kill @n[distance=..1,type=minecraft:marker,tag=EtiPaintBMS.1Paintball,scores={PZPaintBMS.1Wert=1..}]

clear @s

item replace entity @s[scores={PZPaintBMS.1Wert=1}] armor.head with minecraft:leather_helmet[minecraft:enchantments={"minecraft:binding_curse":1},minecraft:tooltip_display={hidden_components:["minecraft:enchantments","minecraft:dyed_color"]},minecraft:custom_data={EigPaintBMS.1Alle:true},minecraft:dyed_color=16711680]
item replace entity @s[scores={PZPaintBMS.1Wert=2}] armor.head with minecraft:leather_helmet[minecraft:enchantments={"minecraft:binding_curse":1},minecraft:tooltip_display={hidden_components:["minecraft:enchantments","minecraft:dyed_color"]},minecraft:custom_data={EigPaintBMS.1Alle:true},minecraft:dyed_color=255]
...
$execute at @n[type=minecraft:interaction,tag=EtiPaintBMS.1Startpunkt,tag=EtiPaintBMS.1Teleport] run spreadplayers ~ ~ 1 3 under $(Y) false @s
