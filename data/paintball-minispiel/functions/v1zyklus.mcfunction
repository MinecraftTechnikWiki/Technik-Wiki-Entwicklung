...
execute at @e[type=minecraft:text_display,tag=EtiPaintBMS.1Teleporter,sort=nearest,limit=1] run particle minecraft:portal ~ ~-3 ~ 0 1 0 0.7 35 force @a[distance=..15]

execute if score VarPaintBMS.1Teilnehmer PZPaintBMS.1Wert matches 10 at @e[type=minecraft:text_display,tag=EtiPaintBMS.1Teleporter,sort=nearest,limit=1] positioned ~ ~-3 ~ run title @a[distance=..3] actionbar ["",{"text":"Lobby ist voll","color":"red","bold":true}]
execute if score VarPaintBMS.1Teilnehmer PZPaintBMS.1Wert matches ..9 at @e[type=minecraft:text_display,tag=EtiPaintBMS.1Teleporter,sort=nearest,limit=1] positioned ~ ~-3 ~ as @p[distance=..3,gamemode=!spectator] run function paintball-minispiel:v1beitreten

execute if score VarPaintBMS.1Wartende PZPaintBMS.1Wert matches 1.. as @e[type=minecraft:interaction,tag=EtiPaintBMS.1Wartesaal,sort=nearest,limit=1] store success score @s PZPaintBMS.1Wert if data entity @s interaction
execute if score VarPaintBMS.1Wartende PZPaintBMS.1Wert matches 1.. as @e[type=minecraft:interaction,tag=EtiPaintBMS.1Wartesaal,scores={PZPaintBMS.1Wert=1},sort=nearest,limit=1] on target run tag @s[team=TMPaintBMS.1Lobby,nbt={SelectedItem:{id:"minecraft:red_bed",components:{"minecraft:custom_data":{EigPaintBMS.1Verlassen:true} } } }] add EtiPaintBMS.1Verlassen
execute if score VarPaintBMS.1Wartende PZPaintBMS.1Wert matches 1.. run data remove entity @e[type=minecraft:interaction,tag=EtiPaintBMS.1Wartesaal,scores={PZPaintBMS.1Wert=1},sort=nearest,limit=1] interaction
...
execute if score VarPaintBMS.1Spielende PZPaintBMS.1Wert matches 0 at @e[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld,sort=nearest,limit=1] run function paintball-minispiel:v1spielfeld
execute if score VarPaintBMS.1Spielende PZPaintBMS.1Wert matches 0 at @e[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld,sort=nearest,limit=1] as @a[distance=..100,tag=EtiPaintBMS.1Spielen,tag=!EtiPaintBMS.1Verloren] at @s run function paintball-minispiel:v1spielen
...
execute at @e[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld,sort=nearest,limit=1] as @a[distance=..100,team=!] unless entity @s[team=!TMPaintBMS.1Lobby,tag=!EtiPaintBMS.1Spielen] positioned ~-30 ~-1 ~-30 unless entity @s[dx=60,dy=40,dz=60] run function paintball-minispiel:v1verlassen

execute at @e[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld,sort=nearest,limit=1] as @a[distance=..100,team=!TMPaintBMS.1Lobby,tag=!EtiPaintBMS.1Spielen] positioned ~-30 ~-1 ~-30 if entity @s[dx=60,dy=40,dz=60] run function paintball-minispiel:v1verlassen
...
execute at @e[type=minecraft:interaction,tag=EtiPaintBMS.1Wartesaal,sort=nearest,limit=1] as @a[distance=..100,team=TMPaintBMS.1Lobby] run function paintball-minispiel:v1auswahl

execute store result score VarPaintBMS.1Teilnehmer PZPaintBMS.1Wert if entity @a[tag=EtiPaintBMS.1Teilnehmer]

data modify entity @e[distance=..15,type=minecraft:text_display,tag=EtiPaintBMS.1Teleporter,sort=nearest,limit=1] text set value '["",{"text":"Lobby","color":"yellow","bold":true},"\\n",{"score":{"name":"VarPaintBMS.1Teilnehmer","objective":"PZPaintBMS.1Wert"},"color":"dark_purple","bold":true},{"text":"/","bold":true},{"text":"10","color":"dark_purple","bold":true}]'

execute if score VarPaintBMS.1Wartende PZPaintBMS.1Wert matches 1.. as @e[type=minecraft:interaction,tag=EtiPaintBMS.1Wartesaal,sort=nearest,limit=1] at @s run function paintball-minispiel:v1warten

execute if score VarPaintBMS.1Zaehlen PZPaintBMS.1Wert matches 1 at @e[type=minecraft:interaction,tag=EtiPaintBMS.1Wartesaal,sort=nearest,limit=1] as @e[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld,sort=nearest,limit=1] run function paintball-minispiel:v1spielstart

execute if score VarPaintBMS.1Spielen PZPaintBMS.1Wert matches 1 if score VarPaintBMS.1Spielende PZPaintBMS.1Wert matches 1 at @e[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld,sort=nearest,limit=1] run function paintball-minispiel:v1spielende

execute at @e[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld,sort=nearest,limit=1] run kill @e[distance=..100,type=minecraft:item,nbt={Item:{id:"minecraft:snowball",components:{"minecraft:custom_data":{EigPaintBMS.1Alle:true} } } }]
