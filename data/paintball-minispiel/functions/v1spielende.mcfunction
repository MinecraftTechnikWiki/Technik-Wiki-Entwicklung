...
execute at @e[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld,sort=nearest,limit=1] run clear @a[distance=..100,tag=EtiPaintBMS.1Spielen] minecraft:golden_shovel[minecraft:custom_data~{EigPaintBMS.1Alle:true}]
