...
item replace entity @s hotbar.8 with minecraft:red_banner[minecraft:enchantments={levels:{"minecraft:binding_curse":1} },minecraft:custom_name='{"text":"Rotes Team","color":"red","bold":true}',minecraft:custom_data={EigPaintBMS.1Alle:true,EigPaintBMS.1Team:1}]
item replace entity @s hotbar.7 with minecraft:blue_banner[minecraft:enchantments={levels:{"minecraft:binding_curse":1} },minecraft:custom_name='{"text":"Blaues Team","color":"blue","bold":true}',minecraft:custom_data={EigPaintBMS.1Alle:true,EigPaintBMS.1Team:2}]
