...
execute as @e[distance=..100,type=minecraft:marker,tag=EtiPaintBMS.1Paintball] at @s as @a[distance=..2.5,tag=EtiPaintBMS.1Spielen,gamemode=!spectator] run function paintball-minispiel:v1treffer with entity @e[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld,sort=nearest,limit=1] data."EigPaintBMS.1Argumente"
...
execute at @e[distance=..100,type=minecraft:snowball,tag=!EtiPaintBMS.1Paintball] summon minecraft:marker store result score @s PZPaintBMS.1Verlassen run ride @s mount @e[type=minecraft:snowball,tag=!EtiPaintBMS.1Paintball,sort=nearest,limit=1]
