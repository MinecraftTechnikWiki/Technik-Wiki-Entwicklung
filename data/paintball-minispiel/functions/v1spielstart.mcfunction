...
execute as @a[tag=EtiPaintBMS.1Spielen] at @s run function paintball-minispiel:v1treffer with entity @e[type=minecraft:marker,tag=EtiPaintBMS.1Spielfeld,sort=nearest,limit=1] data."EigPaintBMS.1Argumente"
