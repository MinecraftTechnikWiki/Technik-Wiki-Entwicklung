...
scoreboard players set @e[type=minecraft:item,tag=!EtiRezM.4Drop,distance=..25,nbt={Item:{id:"minecraft:furnace",tag:{EigRezM.4Alle:true} } }] PZRezM.4Nr 1
scoreboard players set @e[type=minecraft:item,tag=!EtiRezM.4Drop,distance=..25,nbt={Item:{id:"minecraft:coal",tag:{EigRezM.4Alle:true} } }] PZRezM.4Nr 2
scoreboard players set @e[type=minecraft:item,tag=!EtiRezM.4Drop,distance=..25,nbt={Item:{id:"minecraft:porkchop",tag:{EigRezM.4Alle:true} } }] PZRezM.4Nr 3
scoreboard players set @e[type=minecraft:item,tag=!EtiRezM.4Drop,distance=..25,nbt={Item:{id:"minecraft:cooked_porkchop",tag:{EigRezM.4Alle:true} } }] PZRezM.4Nr 4
tag @e[type=minecraft:item,tag=!EtiRezM.4Drop,scores={PZRezM.4Nr=1..},distance=..25,nbt={Item:{tag:{EigRezM.4Alle:true} } }] add EtiRezM.4Drop
