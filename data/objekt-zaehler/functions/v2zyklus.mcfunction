...
execute as @a[distance=..50] store result score @s PZObjZae.2Grenz run clear @s minecraft:magenta_glazed_terracotta{EigObjZae.2Alle:true} 0
...
execute as @a[distance=..50] if score @s PZObjZae.2Anz > @s PZObjZae.2Grenz run tellraw @s ["Objekt-Zähler.2: ",{"text":"Die Obergrenze wurde überschritten!","color":"red","bold":true} ]
