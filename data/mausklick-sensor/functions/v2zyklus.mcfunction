...
scoreboard players set @p[distance=..50,scores={PZMausKS.2Klick=1..},nbt=!{SelectedItem:{id:"minecraft:lime_dye"} },nbt=!{SelectedItem:{id:"minecraft:orange_dye"} },nbt=!{SelectedItem:{id:"minecraft:red_dye"} }] PZMausKS.2Klick 0
scoreboard players set @p[distance=..50,nbt={SelectedItem:{id:"minecraft:lime_dye",tag:{mausklick-sensor:"v2gegenstand"} } }] PZMausKS.2Klick 1
scoreboard players set @p[distance=..50,nbt={SelectedItem:{id:"minecraft:orange_dye",tag:{mausklick-sensor:"v2gegenstand"} } }] PZMausKS.2Klick 2
scoreboard players set @p[distance=..50,nbt={SelectedItem:{id:"minecraft:red_dye",tag:{mausklick-sensor:"v2gegenstand"} } }] PZMausKS.2Klick 3
...
scoreboard players set @e[type=minecraft:armor_stand,tag=EtiMausKS.2Sensor,nbt={HandItems:[{id:"minecraft:red_dye"}]}] PZMausKS.2Klick 3
