...
execute at @e[type=minecraft:marker,tag=EtiParc.1Block,tag=EtiParc.1NeuerBlock,limit=1] run scoreboard players add @e[distance=..15,type=minecraft:marker,tag=EtiParc.1Block] PZParc.1Wert 1





execute at @e[type=minecraft:marker,tag=EtiParc.1Block,tag=EtiParc.1NeuerBlock] run tag @e[distance=..15,type=minecraft:marker,tag=EtiParc.1Block,scores={PZParc.1Wert=1},sort=random,limit=1] add EtiParc.1NeuerBlock
...
execute as @a[tag=EtiParc.1Spieler] at @s unless entity @e[distance=..15,type=minecraft:marker,tag=EtiParc.1Block] at @e[type=minecraft:armor_stand,tag=EtiParc.1Plattform,sort=nearest,limit=1] run teleport @s ~5 ~ ~
