...
give @a[distance=..15] minecraft:armor_stand[minecraft:entity_data={ArmorItems:[{},{},{},{count:1,id:"minecraft:orange_concrete"}],Invisible:true,NoGravity:true,Small:true,Tags:["EtiParc.3Alle","EtiParc.3Block","EtiParc.3Orange"],id:"minecraft:armor_stand"},minecraft:lore=['"Platziere den Rüstungsständer"','"um den Farbblock zu erstellen"'],minecraft:custom_name='{"text":"Orange","color":"gold","bold":true}',minecraft:custom_data={EigParc.3Alle:true}]

give @a[distance=..15] minecraft:armor_stand[minecraft:entity_data={ArmorItems:[{},{},{},{count:1,id:"minecraft:light_blue_concrete"}],Invisible:true,NoGravity:true,Small:true,Tags:["EtiParc.3Alle","EtiParc.3Block","EtiParc.3Hellblau"],id:"minecraft:armor_stand"},minecraft:lore=['"Platziere den Rüstungsständer"','"um den Farbblock zu erstellen"'],minecraft:custom_name='{"text":"Herllblau","color":"aqua","bold":true}',minecraft:custom_data={EigParc.3Alle:true}]
