...
scoreboard objectives add PZSchadS.2Zeit dummy
scoreboard objectives add PZSchadS.2Tote dummy


summon minecraft:falling_block ~ ~10 ~ {Time:0,Tags:["EtiSchadS.2Alle"],Passengers:[{id:"minecraft:armor_stand",Small:true,Invisible:true,Tags:["EtiSchadS.2Alle","EtiSchadS.2Zone","EtiSchadS.2Kugel"],equipment:{head:{id:"minecraft:barrier",count:1} } },{id:"minecraft:armor_stand",Small:true,Invisible:true,Tags:["EtiSchadS.2Alle","EtiSchadS.2Zone","EtiSchadS.2Kugel"],equipment:{head:{id:"minecraft:barrier",count:1} } },{id:"minecraft:armor_stand",Small:true,Invisible:true,Tags:["EtiSchadS.2Alle","EtiSchadS.2Zone","EtiSchadS.2Kubus"],equipment:{head:{id:"minecraft:barrier",count:1} } },{id:"minecraft:armor_stand",Small:true,Invisible:true,Tags:["EtiSchadS.2Alle","EtiSchadS.2Zone","EtiSchadS.2Kubus"],equipment:{head:{id:"minecraft:barrier",count:1} } } ] }
...
execute as @a[tag=EtiSchadS.2Gefangen,tag=!EtiSchadS.2InZone] at @s positioned as @n[type=minecraft:armor_stand,tag=EtiSchadS.2Zone,scores={PZSchadS.2Zeit=1..}] run teleport @s ~ ~ ~ ~ ~
