...
execute at @e[type=minecraft:armor_stand,tag=EtiZonMa.3Alle] run fill ~-7 ~ ~-7 ~8 ~ ~8 minecraft:stone_slab replace minecraft:air
execute at @e[type=minecraft:armor_stand,tag=EtiZonMa.3Alle] run fill ~-6 ~ ~-6 ~7 ~ ~7 minecraft:air replace minecraft:stone_slab
