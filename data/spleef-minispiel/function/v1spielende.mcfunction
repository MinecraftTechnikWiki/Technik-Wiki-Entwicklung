...
execute at @n[type=minecraft:marker,tag=EtiSpleeMS.1Spielfeld] run clear @a[distance=..100,tag=EtiSpleeMS.1Spielen] minecraft:golden_shovel[minecraft:custom_data~{EigSpleeMS.1Alle:true}]
...
execute at @n[type=minecraft:marker,tag=EtiSpleeMS.1Ebene] run place template spleef-minispiel:v1ebene ~ ~ ~ none
execute at @n[type=minecraft:marker,tag=EtiSpleeMS.1Ebene] run place template spleef-minispiel:v1ebene ~ ~ ~ clockwise_90
execute at @n[type=minecraft:marker,tag=EtiSpleeMS.1Ebene] run place template spleef-minispiel:v1ebene ~ ~ ~ 180
execute at @n[type=minecraft:marker,tag=EtiSpleeMS.1Ebene] run place template spleef-minispiel:v1ebene ~ ~ ~ counterclockwise_90
