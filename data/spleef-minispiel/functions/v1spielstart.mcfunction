...
item replace entity @a[tag=EtiSpleeMS.1Spielen] weapon.mainhand with minecraft:golden_shovel[minecraft:lore=['"Nutze diese Schaufel"','"um beim Spleef allen"','"den Boden unter den"','"Füßen wegzugraben!"'],minecraft:attribute_modifiers={modifiers:[{amount:-1,name:"Spleef-Minispiel",operation:"add_value",slot:"mainhand",type:"minecraft:generic.attack_damage",uuid:[I;1,1,1,1]}],show_in_tooltip:false},minecraft:enchantments={levels:{"minecraft:efficiency":10,"minecraft:unbreaking":10} },minecraft:unbreakable={show_in_tooltip:false},minecraft:custom_name='{"text":"Spleef-Schaufel","bold":true}',minecraft:can_break={predicates:[{blocks:"minecraft:snow_block"}],show_in_tooltip:false},minecraft:custom_data={EigSpleeMS.1Alle:true}]
