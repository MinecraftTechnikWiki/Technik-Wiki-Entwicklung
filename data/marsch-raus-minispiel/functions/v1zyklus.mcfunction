...
execute at @a[scores={PZMADNMS.1Drop=1..}] as @e[type=minecraft:item,nbt={Item:{id:"minecraft:player_head",components:{"minecraft:custom_data":{EigMADNMS.1Wuerfel:true} } } },sort=nearest,limit=1] run function marsch-raus-minispiel:v1wuerfel_zahl
