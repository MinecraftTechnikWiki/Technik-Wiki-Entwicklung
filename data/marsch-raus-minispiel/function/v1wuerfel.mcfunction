...
execute if score @s PZMADNMS.1Drop matches 6 as @e[type=minecraft:armor_stand,tag=EtiMADNMS.1Startfeld,tag=EtiMADNMS.1Team] if score @s PZMADNMS.1Team = VarMADNMS.1Farbe PZMADNMS.1Team at @s if score @s PZMADNMS.1Team = @n[distance=..3,type=minecraft:armor_stand,tag=EtiMADNMS.1Figur] PZMADNMS.1Team as @e[type=minecraft:armor_stand,tag=EtiMADNMS.1Haus] if score @s PZMADNMS.1Team = VarMADNMS.1Farbe PZMADNMS.1Team at @s store success score VarMADNMS.1StartfeldBlockiert PZMADNMS.1Team run kill @e[distance=..3,tag=EtiMADNMS.1ZugAuswahl]

#execute as @e[type=minecraft:armor_stand,tag=EtiMADNMS.1Startfeld,tag=EtiMADNMS.1Team] if score @s PZMADNMS.1Team = @n[distance=..3,type=minecraft:armor_stand,tag=EtiMADNMS.1Figur] PZMADNMS.1Team at @s if score @s PZMADNMS.1Team = @n[distance=..3,type=minecraft:armor_stand,tag=EtiMADNMS.1Figur] PZMADNMS.1Team as @e[type=minecraft:armor_stand,tag=EtiMADNMS.1BodenZugAuswahl] at @s if entity @e[distance=..3,type=minecraft:armor_stand,tag=EtiMADNMS.1Haus] run kill @e[distance=..3,tag=EtiMADNMS.1ZugAuswahl]
