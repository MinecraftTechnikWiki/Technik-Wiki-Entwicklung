...
execute at @s[tag=EtiFeld.p2FeldAnzahlDimension1Anheben,scores={PZFeld.p2Felder=..63}] run summon minecraft:armor_stand ~ ~1 ~ {NoGravity:true,Small:true,Invisible:true,Marker:true,CustomName:"{\"text\":\"ObjFeld.p2FeldDimension1\"}",Tags:["EtiFeld.p2AlleFelder","EtiFeld.p2Dimensionen","EtiFeld.p2Dimension2Erhalten"],ArmorItems:[{},{},{},{id:"minecraft:red_shulker_box",Count:1b} ] }
