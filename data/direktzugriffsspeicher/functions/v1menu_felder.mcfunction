...
execute at @s[tag=EtiFeld.1FeldAnzahlAnheben,scores={PZFeld.1Pos=..63}] as @e[type=minecraft:armor_stand,tag=EtiFeld.1Inhalt] at @s run teleport @s ~ ~1 ~
...
execute at @s[tag=EtiFeld.1FeldAnzahlAnheben,scores={PZFeld.1Pos=..63}] run summon minecraft:armor_stand ~ ~1.5 ~ {NoGravity:true,Small:true,Invisible:true,Marker:true,CustomNameVisible:true,CustomName:'{"text":"0","color":"dark_purple","bold":true}',Tags:["EtiFeld.1AlleFelder","EtiFeld.1Inhalt"],ArmorItems:[{},{},{},{id:"minecraft:chest",Count:1b} ] }
execute as @s[tag=EtiFeld.1FeldAnzahlAnheben,scores={PZFeld.1Pos=..63}] run scoreboard players add @e[type=minecraft:armor_stand,tag=EtiFeld.1Inhalt] PZFeld.1Pos 1
...
execute at @s[tag=EtiFeld.1FeldAnzahlAnheben] store result score @s PZFeld.1Pos if entity @e[type=minecraft:armor_stand,tag=EtiFeld.1Inhalt]
...
execute at @s[tag=EtiFeld.1FeldAnzahlVerringern,scores={PZFeld.1Pos=1..}] run kill @e[type=minecraft:armor_stand,tag=EtiFeld.1Inhalt,sort=furthest,limit=1]
...
execute at @s[tag=EtiFeld.1FeldAnzahlVerringern] store result score @s PZFeld.1Pos if entity @e[type=minecraft:armor_stand,tag=EtiFeld.1Inhalt]
