...
execute as @e[type=minecraft:armor_stand,tag=EtiFeld.p3Inhalt,tag=EtiFeld.p3AlleFelder] if score @s PZFeld.p3Pos = #VarFeld.p3PositionAusgeben PZFeld.p3Pos run scoreboard players operation #VarFeld.p3WertInhalt PZFeld.p3Wert = @s PZFeld.p3Wert
