...
execute at @s[tag=EtiFeld.p1PositionAufsteigen] run tellraw @a[distance=..25] ["Direktzugriffsspeicher.erweitert.1:"]
...
# Gibt die veränderten Positionen als tellraw-Nachrichten aus
execute at @s[tag=EtiFeld.p1PositionAbsteigen] run tellraw @a[distance=..25] ["Direktzugriffsspeicher.erweitert.1:"]
