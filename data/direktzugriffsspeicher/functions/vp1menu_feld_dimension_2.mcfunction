...
execute if entity @s[tag=EtiFeld.p1FeldAnzahlDimension2Anheben] if score #VarFeld.p1Dimension2 PZFeld.p1Felder matches ..63 run scoreboard players add @e[type=minecraft:armor_stand,tag=EtiFeld.p1FeldDimension1,tag=EtiFeld.p1AlleFelder,tag=EtiFeld.p1Dimensionen] PZFeld.p1Felder 1
