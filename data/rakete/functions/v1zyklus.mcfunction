...
execute if score VarRakete.1Zaehler PZRakete.1Wert matches 0 at @a[tag=EtiRakete.1Sitzt,scores={PZRakete.1Wert=0}] run scoreboard players operation @e[distance=..1,type=minecraft:horse,tag=EtiRakete.1Rakete,scores={PZRakete.1Wert=..128},sort=nearest,limit=1] PZRakete.1Wert *= KonstRakete.1ZWEI PZRakete.1Wert
