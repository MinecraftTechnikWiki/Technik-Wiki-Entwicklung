...
execute if score VarSchlK.1Variable PZSchlK.1Wert matches 0.. as @a[distance=..15] unless entity @s[scores={PZSchlK.1Wert=0}] run tellraw @a[distance=..15] ["Zähler.1:\n",{"text":"var = ","bold":true},{"text":"0","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Variable = 0"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchlK.1Wert set 1"} },"\n",{"text":"var = ","bold":true},{"text":"var + 1","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Variable + 1"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchlK.1Wert set 2"} },"\n",{"text":"var == ","bold":true},{"score":{"name":"VarSchlK.1Variable","objective":"PZSchlK.1Wert"},"color":"dark_purple","bold":true},"\n",{"text":"gegenstand(var)","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Anzahl von Gegenständen"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchlK.1Wert set 3"} } ]
