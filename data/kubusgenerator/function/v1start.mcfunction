...
tellraw @s ["Kubusgenerator.1:\n",{text:"kante = ",bold:true},{text:"wert_5",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für den Wert 5"} },click_event:{action:"run_command",command:"/trigger PZKubusG.1Wert set 5"} },"\n",{text:"kante = ",bold:true},{text:"wert_10",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für den Wert 10"} },click_event:{action:"run_command",command:"/trigger PZKubusG.1Wert set 10"} },"\n",{text:"kante = ",bold:true},{text:"wert_15",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für den Wert 15"} },click_event:{action:"run_command",command:"/trigger PZKubusG.1Wert set 15"} },"\n",{text:"kante = ",bold:true},{text:"wert_20",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für den Wert 20"} },click_event:{action:"run_command",command:"/trigger PZKubusG.1Wert set 20"} },"\n",{text:"kante = ",bold:true},{text:"wert_25",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für den Wert 25"} },click_event:{action:"run_command",command:"/trigger PZKubusG.1Wert set 25"} },"\n",{text:"kante = ",bold:true},{text:"wert_30",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für den Wert 30"} },click_event:{action:"run_command",command:"/trigger PZKubusG.1Wert set 30"} },"\n",{text:"kante == ",bold:true},{text:"wert_",color:"dark_purple",bold:true},{score:{name:"VarKubusG.1Variable",objective:"PZKubusG.1Wert"},color:"dark_purple",bold:true}]
...
execute if entity @a[distance=..15,scores={PZSchlK.1Wert=3}] if score VarSchlK.1Schleife PZSchlK.1Wert < VarSchlK.1Variable PZSchlK.1Wert run setblock ~ ~1 ~ minecraft:chain_command_block[facing=south]{auto:true,UpdateLastExecution:false,Command:"give @p[distance=..15,scores={PZSchlK.1Wert=3}] minecraft:coal[minecraft:custom_data={EigSchlK.1Alle:true}]"} replace
...
execute if score VarSchlK.1Variable PZSchlK.1Wert matches 0.. as @a[distance=..15] unless entity @s[scores={PZSchlK.1Wert=0}] run tellraw @a[distance=..15] ["Zähler.1:\n",{text:"var = ",bold:true},{text:"0",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Variable = 0"} },click_event:{action:"run_command",command:"/trigger PZSchlK.1Wert set 1"} },"\n",{text:"var = ",bold:true},{text:"var + 1",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Variable + 1"} },click_event:{action:"run_command",command:"/trigger PZSchlK.1Wert set 2"} },"\n",{text:"var == ",bold:true},{score:{name:"VarSchlK.1Variable",objective:"PZSchlK.1Wert"},color:"dark_purple",bold:true},"\n",{text:"gegenstand(var)",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Anzahl von Gegenständen"} },click_event:{action:"run_command",command:"/trigger PZSchlK.1Wert set 3"} } ]
