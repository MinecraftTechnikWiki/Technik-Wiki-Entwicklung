...
execute at @s run data merge entity @e[distance=..5,sort=nearest,limit=1,type=minecraft:item,nbt={Item:{tag:{zonen-system:"v2gegenstand",} } }] {PickupDelay:100s,CustomNameVisible:true,CustomName:'{"text":"Zonenoptionen"}',Tags:["EtiZone.2ZoneErstellen"]}
