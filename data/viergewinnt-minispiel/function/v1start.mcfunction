...
execute if entity @s[tag=EtiVierGM.1Rot] run item replace entity @n[type=minecraft:item_frame,tag=EtiVierGM.1Farbe] contents with minecraft:red_concrete[minecraft:custom_data={EigVierGM.1Alle:true,EigVierGM.1Menu:true}]
execute if entity @s[tag=EtiVierGM.1Gelb] run item replace entity @n[type=minecraft:item_frame,tag=EtiVierGM.1Farbe] contents with minecraft:green_concrete[minecraft:custom_data={EigVierGM.1Alle:true,EigVierGM.1Menu:true}]
...
execute if entity @s[scores={PZVierGM.1Wert=1}] run item replace entity @p hotbar.1 from entity @n[type=minecraft:item_frame,tag=EtiVierGM.1Farbe] contents
...
execute if entity @s[scores={PZVierGM.1Wert=1}] run item replace entity @p hotbar.2 from entity @n[type=minecraft:item_frame,tag=EtiVierGM.1Farbe] contents
...
execute if entity @s[scores={PZVierGM.1Wert=1}] run item replace entity @p hotbar.3 from entity @n[type=minecraft:item_frame,tag=EtiVierGM.1Farbe] contents
...
execute if entity @s[scores={PZVierGM.1Wert=1}] run item replace entity @p hotbar.4 from entity @n[type=minecraft:item_frame,tag=EtiVierGM.1Farbe] contents
...
execute if entity @s[scores={PZVierGM.1Wert=1}] run item replace entity @p hotbar.5 from entity @n[type=minecraft:item_frame,tag=EtiVierGM.1Farbe] contents
...
execute if entity @s[scores={PZVierGM.1Wert=1}] run item replace entity @p hotbar.6 from entity @n[type=minecraft:item_frame,tag=EtiVierGM.1Farbe] contents
...
execute if entity @s[scores={PZVierGM.1Wert=1}] run item replace entity @p hotbar.7 from entity @n[type=minecraft:item_frame,tag=EtiVierGM.1Farbe] contents

execute at @e[type=minecraft:marker,tag=EtiVierGM.1Oben,tag=EtiVierGM.1Belegen] run summon minecraft:falling_block ~ ~ ~ {BlockState:{Name:"minecraft:blue_concrete"},Tags:["EtiVierGM.1Alle","EtiVierGM.1Konstruktion"]}
execute at @e[type=minecraft:marker,tag=EtiVierGM.1Oben,tag=EtiVierGM.1Belegen] run summon minecraft:falling_block ~ ~1 ~ {BlockState:{Name:"minecraft:blue_concrete"},Tags:["EtiVierGM.1Alle","EtiVierGM.1Konstruktion"]}
