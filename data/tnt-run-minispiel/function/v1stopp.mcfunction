...
execute at @n[type=minecraft:text_display,tag=EtiTNTRMS.1Teleporter] run fill ~-8 ~-3 ~-8 ~8 ~15 ~8 minecraft:air replace

execute at @n[type=minecraft:marker,tag=EtiTNTRMS.1Spielfeld] run fill ~ ~ ~ ~26 ~33 ~26 minecraft:air replace
execute at @n[type=minecraft:marker,tag=EtiTNTRMS.1Spielfeld] run fill ~ ~ ~ ~-26 ~33 ~26 minecraft:air replace
execute at @n[type=minecraft:marker,tag=EtiTNTRMS.1Spielfeld] run fill ~ ~ ~ ~26 ~33 ~-26 minecraft:air replace
execute at @n[type=minecraft:marker,tag=EtiTNTRMS.1Spielfeld] run fill ~ ~ ~ ~-26 ~33 ~-26 minecraft:air replace
...
execute at @n[type=minecraft:marker,tag=EtiTNTRMS.1Spielfeld] positioned ~-30 ~-1 ~-30 run kill @e[dx=60,dy=40,dz=60,type=minecraft:item]

execute at @n[type=minecraft:text_display,tag=EtiTNTRMS.1Teleporter] positioned ~-10 ~-4 ~-10 run kill @e[dx=20,dy=20,dz=20,type=minecraft:item]
