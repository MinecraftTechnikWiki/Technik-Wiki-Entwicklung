...
execute if entity @s[tag=EtiSchMS.1KoenigAufgeben] positioned ~-0.5 ~ ~-0.5 run data merge entity @n[dx=1,dy=-10,dz=1,type=minecraft:shulker,tag=EtiSchMS.1ZugAuswahl,tag=!EtiSchMS.1KoenigAufgeben,sort=furthest] {Health:29.0f}
