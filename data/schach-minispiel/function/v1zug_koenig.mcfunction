...
execute as @e[tag=EtiSchMS.1Turm,scores={PZSchMS.1Spielz=0}] if score @s PZSchMS.1Farbe = @n[tag=EtiSchMS.1Koenig,tag=EtiSchMS.1Anklickbar,scores={PZSchMS.1Spielz=0}] PZSchMS.1Farbe run tag @s add EtiSchMS.1KoenigsZugTesten

tag @e[tag=EtiSchMS.1KoenigDoppelZug] remove EtiSchMS.1KoenigDoppelZug
execute as @e[tag=EtiSchMS.1KoenigsZugTesten] at @s at @n[distance=..3,tag=EtiSchMS.1Turm,tag=EtiSchMS.1FigurBoden] run function schach-minispiel:v1zug_koenig_turm
execute as @e[tag=EtiSchMS.1KoenigsZugTesten,tag=!EtiSchMS.1KoenigDoppelZug] at @s at @n[tag=EtiSchMS.1Turm,tag=EtiSchMS.1FigurBoden] positioned ^3 ^ ^ if block ~ ~1 ~ #schach-minispiel:v1schachbloecke unless entity @e[distance=..2,tag=EtiSchMS.1Figur] run function schach-minispiel:v1zug_koenig_turm

execute as @e[tag=EtiSchMS.1KoenigsZugTesten,tag=!EtiSchMS.1KoenigDoppelZug] at @s at @n[tag=EtiSchMS.1Turm,tag=EtiSchMS.1FigurBoden] rotated ~180 ~ run function schach-minispiel:v1zug_koenig_turm
execute as @e[tag=EtiSchMS.1KoenigsZugTesten,tag=!EtiSchMS.1KoenigDoppelZug] at @s at @n[tag=EtiSchMS.1Turm,tag=EtiSchMS.1FigurBoden] rotated ~180 ~ positioned ^3 ^ ^ if block ~ ~1 ~ #schach-minispiel:v1schachbloecke unless entity @e[distance=..2,tag=EtiSchMS.1Figur] run function schach-minispiel:v1zug_koenig_turm
