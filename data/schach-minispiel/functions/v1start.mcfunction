...
give @p[distance=..15] minecraft:armor_stand{EigSchMS.1Alle:true,Enchantments:[{id:-1}],display:{Name:'{"text":"Schach"}',Lore:['"Platziere den Rüstungsständer"','"um ein Schachfeld zu"','"erzeugen"']},EntityTag:{Marker:true,Tags:["EtiSchMS.1Alle","EtiSchMS.1SchachbrettErstellen"] } }
