...
execute positioned ^-3 ^ ^-3 unless entity @e[distance=..2,tag=EtiSchMS.1Figur,tag=!EtiSchMS.1MoeglicherZug] positioned ^6 ^ ^6 if block ~ ~ ~ #schach-minispiel:v1schachbloecke run function schach-minispiel:v1zug_dame_diagonal
