...
execute if entity @s[tag=EtiSchMS.1FigurenGrau] as @e[tag=EtiSchMS.1Figur] positioned ~ ~-2 ~ if score @s PZSchMS.1Farbe = @e[distance=..2,tag=EtiSchMS.1Koenig,tag=EtiSchMS.1Anklickbar,sort=nearest,limit=1] PZSchMS.1Farbe store result entity @s ArmorItems[1].tag.display.color int 1 store result entity @s ArmorItems[2].tag.display.color int 1 store result entity @s ArmorItems[3].tag.display.color int 1 store result entity @s ArmorItem.tag.display.color int 1 run scoreboard players get KonstSchMS.1HELLGRAU PZSchMS.1Farbe
