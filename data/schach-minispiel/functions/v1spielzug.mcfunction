...
execute if score VarSchMS.1Variante PZSchMS.1Brett matches 0 positioned ~ ~-2 ~ if entity @e[distance=..2,tag=EtiSchMS.1Koenig] as @e[type=minecraft:horse,tag=EtiSchMS.1Figur] if score @s PZSchMS.1Farbe = @e[distance=..2,tag=EtiSchMS.1Koenig,tag=EtiSchMS.1Anklickbar,sort=nearest,limit=1] PZSchMS.1Farbe run teleport @s ~ -255 ~
execute if score VarSchMS.1Variante PZSchMS.1Brett matches 0 positioned ~ ~-2 ~ if entity @e[distance=..2,tag=EtiSchMS.1Koenig] as @e[tag=EtiSchMS.1Figur] if score @s PZSchMS.1Farbe = @e[distance=..2,tag=EtiSchMS.1Koenig,tag=EtiSchMS.1Anklickbar,sort=nearest,limit=1] PZSchMS.1Farbe run kill @s
...
execute if entity @s[tag=EtiSchMS.1FigurenGrau] as @e[tag=EtiSchMS.1Figur] positioned ~ ~-2 ~ if score @s PZSchMS.1Farbe = @e[distance=..2,tag=EtiSchMS.1Koenig,tag=EtiSchMS.1Anklickbar,sort=nearest,limit=1] PZSchMS.1Farbe store result entity @s ArmorItems[1].components.minecraft:dyed_color.rgb int 1 store result entity @s ArmorItems[2].components.minecraft:dyed_color.rgb int 1 store result entity @s ArmorItems[3].components.minecraft:dyed_color.rgb int 1 store result entity @s ArmorItem.components.minecraft:dyed_color.rgb int 1 run scoreboard players get KonstSchMS.1HELLGRAU PZSchMS.1Farbe
execute if entity @s[tag=EtiSchMS.1FigurenGrau] as @e[tag=EtiSchMS.1Figur,tag=EtiSchMS.1Farbe] positioned ~ ~-2 ~ if score @s PZSchMS.1Farbe = @e[distance=..2,tag=EtiSchMS.1Koenig,tag=EtiSchMS.1Anklickbar,sort=nearest,limit=1] PZSchMS.1Farbe run data merge entity @s {Color:8b}
execute if entity @s[tag=EtiSchMS.1FigurenGrau] as @e[tag=EtiSchMS.1Figur,tag=EtiSchMS.1Anklickbar] positioned ~ ~-2 ~ if score @s PZSchMS.1Farbe = @e[distance=..2,tag=EtiSchMS.1Koenig,tag=EtiSchMS.1Anklickbar,sort=nearest,limit=1] PZSchMS.1Farbe run tag @s remove EtiSchMS.1Anklickbar

execute positioned ~-0.5 ~ ~-0.5 as @e[dx=1,dy=-5,dz=1,tag=EtiSchMS.1Figur] unless score @s PZSchMS.1Farbe = @e[tag=EtiSchMS.1Figur,tag=EtiSchMS.1Leuchten,sort=nearest,limit=1] PZSchMS.1Farbe run tag @s add EtiSchMS.1Besiegen
...
execute as @e[tag=EtiSchMS.1Turm,tag=EtiSchMS.1FigurBoden,tag=EtiSchMS.1Bewegen,sort=nearest,limit=1] at @s if block ~ ~ ~ minecraft:air run teleport @s ~ ~-1.35 ~
