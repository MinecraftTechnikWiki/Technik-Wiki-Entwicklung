...
scoreboard players reset @a PZSchMS.1Brett

execute if score VarSchMS.1VierSchach PZSchMS.1Brett matches 0 run scoreboard players set VarSchMS.1Groesse PZSchMS.1Brett 8
execute if score VarSchMS.1VierSchach PZSchMS.1Brett matches 1 run scoreboard players set VarSchMS.1Groesse PZSchMS.1Brett 14
execute if score VarSchMS.1VierSchach PZSchMS.1Brett matches 2 run scoreboard players set VarSchMS.1Groesse PZSchMS.1Brett 12
