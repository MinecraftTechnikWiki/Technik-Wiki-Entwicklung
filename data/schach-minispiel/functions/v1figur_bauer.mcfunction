...
data merge entity @e[tag=EtiSchMS.1Bauer,tag=EtiSchMS.1Anklickbar,sort=nearest,limit=1] {HandItems:[{},{id:"minecraft:iron_hoe",Count:1b}],ArmorItems:[{},{id:"minecraft:leather_leggings",Count:1b,tag:{Damage:1,Unbreakable:true,display:{color:16383998}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{Unbreakable:true,display:{color:16383998}}},{id:"minecraft:leather_helmet",Count:1b,tag:{Unbreakable:true,display:{color:16383998}}}]}
