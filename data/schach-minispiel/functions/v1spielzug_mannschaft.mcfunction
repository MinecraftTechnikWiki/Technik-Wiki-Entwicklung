...
scoreboard players operation VarSchMS.1Farbe PZSchMS.1Farbe = @e[distance=..5,type=minecraft:zombified_piglin,tag=EtiSchMS.1Koenig,sort=nearest,limit=1] PZSchMS.1Farbe
