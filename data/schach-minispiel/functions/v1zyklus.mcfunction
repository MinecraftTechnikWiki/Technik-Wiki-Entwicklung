...
execute if score VarSchMS.1VierSchach PZSchMS.1Brett matches 0.. as @a[distance=..250] unless entity @s[scores={PZSchMS.1Brett=0}] run tellraw @s ["Schach-Minispiel.1:",{"text":"\nSchach-Variante = ","color":"dark_purple","hoverEvent":{"action":"show_text","value":{"text":"Tippe für die Variante\n0 = normales Schach\n1 = Viererschach\n2 = Festungsschach"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchMS.1Brett set 1"} },{"score":{"name":"VarSchMS.1VierSchach","objective":"PZSchMS.1Brett"},"bold":true},{"text":"\nHorde = ","color":"dark_purple","hoverEvent":{"action":"show_text","value":{"text":"Tippe für die Horde\n0 = Keine Horde\n1 = Horde"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchMS.1Brett set 2"} },{"score":{"name":"VarSchMS.1Horde","objective":"PZSchMS.1Brett"},"bold":true}]
execute if score VarSchMS.1VierSchach PZSchMS.1Brett matches 0.. as @a unless entity @s[scores={PZSchMS.1Brett=0}] run scoreboard players enable @s PZSchMS.1Brett
