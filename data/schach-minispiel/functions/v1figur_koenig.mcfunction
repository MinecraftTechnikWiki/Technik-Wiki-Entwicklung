...
execute as @e[distance=..3,tag=EtiSchMS.1Koenig,tag=EtiSchMS.1Farbe,sort=nearest,limit=2] run data merge entity @s {CustomNameVisible:true,CustomName:'{"text":"♔","bold":true}',HandItems:[{},{id:"minecraft:golden_sword",count:1}],ArmorItems:[{},{id:"minecraft:leather_leggings",count:1,components:{"minecraft:unbreakable":{},"minecraft:dyed_color":{rgb:16383998} } },{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:unbreakable":{},"minecraft:dyed_color":{rgb:16383998} } },{id:"minecraft:golden_helmet",count:1,components:{"minecraft:custom_data":{Unbreakable:true} } } ] }
