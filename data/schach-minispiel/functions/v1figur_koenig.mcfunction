...
execute as @e[distance=..3,tag=EtiSchMS.1Farbe,sort=nearest,limit=2] run data merge entity @s {HandItems:[{},{id:"minecraft:golden_sword",Count:1b}],ArmorItems:[{},{id:"minecraft:leather_leggings",Count:1b,tag:{Unbreakable:true,display:{color:16383998}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{Unbreakable:true,display:{color:16383998}}},{id:"minecraft:golden_helmet",Count:1b,tag:{Unbreakable:true}}]}
