...
execute if score PZDrRezM.p1Zeit PZDrRezM.p1Drop matches 1.. at @r as @e[distance=..5,type=minecraft:item,tag=EtiDrRezM.p1Handwerk,nbt={EigDrRezM.p1Alle:true},sort=random,limit=1] at @s run function drop-rezeptmaschine:vp1rezept
