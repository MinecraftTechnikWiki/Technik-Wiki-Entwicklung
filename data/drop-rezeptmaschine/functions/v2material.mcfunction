...
execute if entity @s[scores={PZDrRezM.2Fort=-1}] run data modify entity @e[type=minecraft:item,tag=EtiDrRezM.2Hergestellt,sort=nearest,limit=1] Item.components merge from entity @s Item.components
