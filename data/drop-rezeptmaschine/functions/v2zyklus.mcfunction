...
#execute at @e[type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=0}] if entity @e[distance=..3,type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=1..}] run scoreboard players add @e[distance=..3,type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=..-1},sort=nearest,limit=1] PZDrRezM.2Fort 1

execute at @a[scores={PZDrRezM.2Drop=1..}] as @e[type=minecraft:item,tag=!EtiDrRezM.2Drop,nbt={Item:{tag:{EigDrRezM.2Alle:true} } }] run function drop-rezeptmaschine:v2nummer
...
#execute as @e[type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=0}] at @s if entity @e[distance=..3,type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=..-1},sort=nearest,limit=1] if entity @e[distance=..3,type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=1..},sort=nearest,limit=1] run tag @s add EtiDrRezM.2Erhitzen

#execute at @e[type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=0}] if entity @e[distance=..3,type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=..-1},sort=nearest,limit=1] if entity @e[distance=..3,type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=1..},sort=nearest,limit=1] run particle minecraft:flame ~ ~ ~ 0 0 0 0.01 4 force @a[distance=..25]
...
#execute at @e[type=minecraft:item,tag=EtiDrRezM.2Erhitzen] as @e[distance=..3,type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=..-1},nbt={OnGround:true},sort=nearest,limit=1] run function drop-rezeptmaschine:v2brennstoff

#execute at @e[type=minecraft:item,tag=EtiDrRezM.2Erhitzen] as @e[distance=..3,type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=1..},nbt={OnGround:true},sort=nearest,limit=1] at @s run function drop-rezeptmaschine:v2material
