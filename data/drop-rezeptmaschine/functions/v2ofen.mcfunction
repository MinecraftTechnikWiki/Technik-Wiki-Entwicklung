...
#execute at @e[distance=..3,type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=..-1},nbt={OnGround:true},sort=nearest,limit=1] run particle minecraft:cloud ~ ~ ~ 0 0 0 0.01 2 force @a[distance=..25]
