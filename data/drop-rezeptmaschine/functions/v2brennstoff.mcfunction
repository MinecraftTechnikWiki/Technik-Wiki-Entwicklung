...
execute if entity @s[scores={PZDrRezM.2Drop=-3}] run data modify entity @e[type=minecraft:item,tag=EtiDrRezM.2Brennstoff,sort=nearest,limit=1] Item.components merge from entity @s Item.components
