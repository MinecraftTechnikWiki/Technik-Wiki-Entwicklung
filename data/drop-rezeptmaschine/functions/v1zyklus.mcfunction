...
execute if entity @p[scores={PZDrRezM.1Drop=1..}] as @e[type=minecraft:item,tag=!EtiDrRezM.1Drop,nbt={Item:{tag:{EigDrRezM.1Alle:true} } }] run function drop-rezeptmaschine:v1nummer
...
execute as @e[type=minecraft:item,tag=EtiDrRezM.1Rezept1] run data merge entity @s {Item:{id:"minecraft:name_tag",Count:1b},Motion:[0.0d,0.3d,0.0d]}
...
execute as @e[type=minecraft:item,tag=EtiDrRezM.1Rezept2] run data merge entity @s {Item:{id:"minecraft:crossbow",Count:1b},Motion:[0.0d,0.3d,0.0d]}
...
execute as @e[type=minecraft:item,tag=EtiDrRezM.1Rezept3] run data merge entity @s {Item:{id:"minecraft:crossbow",Count:1b},Motion:[0.0d,0.3d,0.0d]}
