...
#scoreboard players remove @n[distance=0.1,type=minecraft:item,tag=EtiDrRezM.2Erhitzen] PZDrRezM.2Fort 1
...
#say @n[distance=0,type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=0}]

scoreboard players operation @n[distance=0,type=minecraft:item,tag=EtiDrRezM.2Drop,scores={PZDrRezM.2Drop=0}] PZDrRezM.2Fort = VarDrRezM.2Brennen PZDrRezM.2Fort

#execute if entity @s[scores={PZDrRezM.2Drop=-1}] run scoreboard players set @n[distance=0.1,type=minecraft:item,tag=EtiDrRezM.2Erhitzen] PZDrRezM.2Fort 100
#execute if entity @s[scores={PZDrRezM.2Drop=-2}] run scoreboard players set @n[distance=0.1,type=minecraft:item,tag=EtiDrRezM.2Erhitzen] PZDrRezM.2Fort 400
#execute if entity @s[scores={PZDrRezM.2Drop=-3}] run scoreboard players set @n[distance=0.1,type=minecraft:item,tag=EtiDrRezM.2Erhitzen] PZDrRezM.2Fort 1200
...
execute if entity @s[scores={PZDrRezM.2Drop=-3}] at @s run summon minecraft:item ~ ~ ~ {PickupDelay:10s,Item:{id:"minecraft:bucket",count:1},Tags:["EtiDrRezM.2Alle","EtiDrRezM.2Brennstoff"],Motion:[0.0d,0.3d,0.0d]}
execute if entity @s[scores={PZDrRezM.2Drop=-3}] run data modify entity @n[type=minecraft:item,tag=EtiDrRezM.2Brennstoff] Item.components merge from entity @s Item.components
execute if entity @s[scores={PZDrRezM.2Drop=-3}] run tag @n[type=minecraft:item,tag=EtiDrRezM.2Brennstoff] remove EtiDrRezM.2Brennstoff
