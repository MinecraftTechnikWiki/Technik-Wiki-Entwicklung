...
execute if entity @s[scores={PZDrRezM.3Fort=..0}] as @n[distance=..2,type=minecraft:item,tag=EtiDrRezM.3Brauen,nbt={OnGround:true}] run function drop-rezeptmaschine:v3brennstoff
