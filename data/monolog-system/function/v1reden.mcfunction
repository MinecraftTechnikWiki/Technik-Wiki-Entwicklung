...
$execute on passengers store result score VarMonoLS.1Nachricht PZMonoLS.1Reden run data get entity @s[type=minecraft:marker] data."EigMonoLS.1Spieler"[{UUID:$(player)}].Nachricht

# Falls der Markierer noch keine Daten für die Nachricht besaß, bekommt er einen Eintrag hinzugefügt.
$execute if score VarMonoLS.1Nachricht PZMonoLS.1Reden matches 0 on passengers unless data entity @s[type=minecraft:marker] data."EigMonoLS.1Spieler"[{UUID:$(player)}] run data modify entity @s[type=minecraft:marker] data."EigMonoLS.1Spieler" append value {Nachricht:0,UUID:$(player)}
...
execute on passengers store result score VarMonoLS.1Nachrichten PZMonoLS.1Reden run data get entity @s[type=minecraft:marker] data."EigMonoLS.1Nachrichten"
...
$execute if score VarMonoLS.1Nachricht PZMonoLS.1Reden < VarMonoLS.1Nachrichten PZMonoLS.1Reden on passengers run function monolog-system:v1nachricht with entity @s[type=minecraft:marker] data."EigMonoLS.1Spieler"[{UUID:$(player)}]
...
$execute on passengers store result entity @s[type=minecraft:marker] data."EigMonoLS.1Spieler"[{UUID:$(player)}].Nachricht int 1 run scoreboard players get VarMonoLS.1Nachricht PZMonoLS.1Reden
