...
execute if score VarBuRezM.1Rezept PZBuRezM.1Buend matches 1.. at @s as @n[type=minecraft:item_frame,tag=EtiBuRezM.1Rahmen] run function buendel-rezeptmaschine:v1rezepte
