...
execute if entity @s[name="Westen"] run setblock ~ ~-1 ~ minecraft:structure_block{rotation:"NONE",mode:"LOAD",posX:-15,posY:0,posZ:-6,name:"schiff:v1schiff"} replace
execute if entity @s[name="Norden"] run setblock ~ ~-1 ~ minecraft:structure_block{rotation:"CLOCKWISE_90",mode:"LOAD",posX:6,posY:0,posZ:-15,name:"schiff:v1schiff"} replace
execute if entity @s[name="Osten"] run setblock ~ ~-1 ~ minecraft:structure_block{rotation:"CLOCKWISE_180",mode:"LOAD",posX:15,posY:0,posZ:6,name:"schiff:v1schiff"} replace
execute if entity @s[name="Süden"] run setblock ~ ~-1 ~ minecraft:structure_block{rotation:"COUNTERCLOCKWISE_90",mode:"LOAD",posX:-6,posY:0,posZ:15,name:"schiff:v1schiff"} replace
