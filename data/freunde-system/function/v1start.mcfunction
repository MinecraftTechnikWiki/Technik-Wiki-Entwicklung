...
loot replace entity @n[distance=..1,type=minecraft:item_frame,tag=EtiFreuS.1Spielerkopf] contents loot freunde-system:spieler

data modify storage freunde-system:v1daten "EigFreuS.1AlleSpieler" append value {EigFreuS.1Nummer:0,EigFreuS.1Name:""}
data modify storage freunde-system:v1daten "EigFreuS.1AlleSpieler"[-1]."EigFreuS.1Name" set from entity @n[distance=..1,type=minecraft:item_frame,tag=EtiFreuS.1Spielerkopf] Item.components.minecraft:profile.name
...
kill @n[distance=..1,type=minecraft:item_frame,tag=EtiFreuS.1Spielerkopf]
...
#tellraw @s ["Freunde-System.1:\n",{text:"spieler (",bold:true},{text:"=naechster()",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für nächsten Spieler"} },click_event:{action:"run_command",command:"/trigger PZFreuS.1Ausl set 1"} },{text:",",bold:true},{text:"=vorheriger()",color:"gray",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für vorherigen Spieler"} },click_event:{action:"run_command",command:"/trigger PZFreuS.1Ausl set -1"} },{text:") == ",bold:true},{storage:"freunde-system:v1daten",nbt:'"EigFreuS.1AlleSpieler"[0]."EigFreuS.1Name"',color:"gold",bold:true},"\n",{text:"freund = ",bold:true},{text:"anfrage()",color:"light_blue",bold:true,underlined:true,hover_event:{action:"show_text",value:{text:"Tippe für Freundschaftsanfrage"} },click_event:{action:"run_command",command:"/trigger PZFreuS.1Ausl set 2"} }]
