...
tellraw @s ["Vokabel-Lerner.1:\n",{"text":"sprache = ","bold":true},{"storage":"vokabel-lerner:v1daten","nbt":"\"EigVokLe.1Sprache\"[0].Text","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","contents":["",{"text":"Tippe für Übersetzung = "},{"storage":"vokabel-lerner:v1daten","nbt":"\"EigVokLe.1Sprache\"[1].Text","bold":true}] },"clickEvent":{"action":"run_command","value":"/trigger PZVokLe.1Ausl set -1"} },"\n",{"text":"uebersetze = ","bold":true},{"storage":"vokabel-lerner:v1daten","nbt":"\"EigVokLe.1Wort\"[0]","color":"gold","bold":true},"\n",{"text":"A) = ","bold":true},{"storage":"vokabel-lerner:v1daten","nbt":"\"EigVokLe.1Worte\"[0][1]","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Antwort A"} },"clickEvent":{"action":"run_command","value":"/trigger PZVokLe.1Ausl set 1"} },"\n",{"text":"B) = ","bold":true},{"storage":"vokabel-lerner:v1daten","nbt":"\"EigVokLe.1Worte\"[1][1]","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Antwort B"} },"clickEvent":{"action":"run_command","value":"/trigger PZVokLe.1Ausl set 2"} },"\n",{"text":"C) = ","bold":true},{"storage":"vokabel-lerner:v1daten","nbt":"\"EigVokLe.1Worte\"[2][1]","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Antwort C"} },"clickEvent":{"action":"run_command","value":"/trigger PZVokLe.1Ausl set 3"} },"\n",{"text":"D) = ","bold":true},{"storage":"vokabel-lerner:v1daten","nbt":"\"EigVokLe.1Worte\"[3][1]","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Antwort D"} },"clickEvent":{"action":"run_command","value":"/trigger PZVokLe.1Ausl set 4"} }]
