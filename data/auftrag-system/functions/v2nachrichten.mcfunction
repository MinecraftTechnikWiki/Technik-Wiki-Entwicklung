...
$tellraw @p[tag=EtiAufTraS.2Spieler] ["",{"text":"[","color":"gray"},{"storage":"auftrag-system:v2daten","nbt":"\"EigAufTraS.2Antworten\"[0].Text","color":"yellow","interpret":true,"bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für die Antwort ID:$(Antwort)"} },"clickEvent":{"action":"run_command","value":"/trigger PZAufTraS.2Antwort set $(Antwort)"} },{"text":"]","color":"gray"}]
