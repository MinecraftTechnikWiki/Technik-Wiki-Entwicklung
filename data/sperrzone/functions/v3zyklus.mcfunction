...
tag @a[tag=EtiSperrZ.3Ausweis,nbt=!{Inventory:[{tag:{display:{Lore:["Sperrzone.3"]} } }]}] remove EtiSperrZ.3Ausweis
tag @a[tag=!EtiSperrZ.3Ausweis,nbt={Inventory:[{tag:{display:{Lore:["Sperrzone.3"]} } }]}] add EtiSperrZ.3Ausweis
