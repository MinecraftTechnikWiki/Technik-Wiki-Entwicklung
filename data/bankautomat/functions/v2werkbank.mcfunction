...
execute as @a[distance=..5] unless entity @s[scores={PZBankA.2Ausl=0}] run tellraw @s ["Bankautomat.2: ",{"text":"\nkontostand = ","bold":true},{"text":"kontostand + 1","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für den Betrag + 1"} },"clickEvent":{"action":"run_command","value":"/trigger PZBankA.2Ausl set 1"},"bold":true},{"text":"\nkontostand = ","bold":true},{"text":"kontostand - 1","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für den Betrag - 1"} },"clickEvent":{"action":"run_command","value":"/trigger PZBankA.2Ausl set -1"},"bold":true},{"text":"\nkontostand == ","bold":true},{"score":{"name":"@s","objective":"PZBankA.2Wert"},"color":"dark_purple","bold":true},{"text":"€","color":"dark_purple","bold":true}]
