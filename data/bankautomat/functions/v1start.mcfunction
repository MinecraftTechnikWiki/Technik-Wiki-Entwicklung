...
give @a[distance=..25] minecraft:armor_stand{bankautomat:"v1gegenstand",display:{Name:'{"text":"Bankautomat","color":"dark_purple","bold":true}',Lore:['"Platziere den Rüstungsständer"','"um einen Bankautomat"','"zu erstellen"'] },EntityTag:{NoGravity:true,Invisible:true,CustomNameVisible:true,CustomName:'{"text":"Bankautomat","color":"dark_purple","bold":true}',Tags:["EtiBankA.1Alle","EtiBankA.1Bankautomat"]} } 16
give @a[distance=..25] minecraft:emerald{bankautomat:"v1gegenstand",display:{Lore:['"Smaragde, Geld für dein Konto"'] } } 64
