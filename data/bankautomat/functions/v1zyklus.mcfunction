...
execute at @e[type=minecraft:armor_stand,tag=EtiBankA.1Werkbank] unless block ~ ~ ~ minecraft:crafting_table run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:armor_stand",Count:1b,tag:{bankautomat:"v1gegenstand",display:{Name:'{"text":"Bankautomat","color":"dark_purple","bold":true}',Lore:['"Platziere den Rüstungsständer"','"um einen Bankautomat"','"zu erstellen"'] },EntityTag:{NoGravity:true,Invisible:true,CustomNameVisible:true,CustomName:'{"text":"Bankautomat","color":"dark_purple","bold":true}',Tags:["EtiBankA.1Alle","EtiBankA.1Bankautomat"]} } },Motion:[0.0d,0.3d,0.0d]}
...
execute at @e[type=minecraft:armor_stand,tag=EtiBankA.1Werkbank] run give @a[distance=..5,scores={PZBankA.1Klick=-1,PZBankA.1Wert=1..}] minecraft:emerald{bankautomat:"v1gegenstand",display:{Lore:['"Smaragde, Geld für dein Konto"']} } 1
...
execute at @e[type=minecraft:armor_stand,tag=EtiBankA.1Werkbank] as @a[distance=..5] unless entity @s[scores={PZBankA.1Klick=0}] run tellraw @s ["Bankautomat.1: ",{"text":"\nkontostand (","bold":true},{"text":"+1","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für den Betrag +1"} },"clickEvent":{"action":"run_command","value":"/trigger PZBankA.1Klick set 1"},"bold":true},{"text":"!","bold":true},{"text":"-1","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für den Betrag -1"} },"clickEvent":{"action":"run_command","value":"/trigger PZBankA.1Klick set -1"},"bold":true},{"text":") == ","bold":true},{"score":{"name":"@s","objective":"PZBankA.1Wert"},"color":"dark_purple","bold":true},{"text":"€","color":"dark_purple","bold":true}]
