...
scoreboard players set @n[type=minecraft:marker,tag=EtiKNeur.1Neuron] PZKNeur.1Wert 2


summon minecraft:armor_stand ~ ~2 ~ {Small:true,Invisible:true,NoGravity:true,CustomNameVisible:true,CustomName:["",{text:"Σ",color:"gold",bold:true},{text:">=",color:"gray",bold:true},{text:"2",color:"dark_purple",bold:true}],equipment:{head:{id:"minecraft:ender_eye",count:1} },DisabledSlots:2039583,Tags:["EtiKNeur.1Alle","EtiKNeur.1Wert"]}
