...
tellraw @a[distance=..15] ["Grund-Element.1: ",{"text":"\nKlicke auf 'Trigger-Befehl' um einen Befehl in der Chat-Leiste zu erhalten.","color":"gold","bold":true},{"text":"\nTrigger-Befehl","color":"yellow","underlined":true,"bold":true,"clickEvent":{"action":"suggest_command","value":"/trigger PZGruEl.1Ausl"},"hoverEvent":{"action":"show_text","value":{"text":"","extra":[{"text":"Erhalte den Trigger-Befehl","color":"green"} ] } } } ]
