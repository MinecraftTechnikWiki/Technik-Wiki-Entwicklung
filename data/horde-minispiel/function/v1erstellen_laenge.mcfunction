...
summon area_effect_cloud ~ ~ ~ {custom_particle:{type:"minecraft:block",block_state:"minecraft:air"},Duration:-1,Age:-2147483648,WaitTime:-2147483648,Tags:["EtiHordMS.1Alle","EtiHordMS.1Bereich"]}
