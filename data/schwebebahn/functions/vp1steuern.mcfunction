...
execute unless entity @s[tag=EtiSchwB.p1SitztInLore,scores={PZSchwB.p1Ausl=0}] run tellraw @s ["Schwebebahn.erweitert.1:\n",{"text":"fahren = ","bold":true},{"text":"wahr","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Wert wahr"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p1Ausl set 1"} },"\n",{"text":"fahren = ","bold":true},{"text":"falsch","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Wert falsch"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p1Ausl set 2"} },"\n",{"text":"fahren == ","bold":true},{"entity":"@e[distance=..2,type=minecraft:armor_stand,tag=EtiSchwB.p1Fahren,sort=nearest,limit=1]","nbt":"CustomName","interpret":true},"\n",{"text":"richtungumkehren() == ","bold":true},{"text":"180°","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe um den Zug umzudrehen"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p1Ausl set 3"} }]
...
execute as @e[distance=..2,type=minecraft:armor_stand,tag=EtiSchwB.p1Fahren,name="wahr",sort=nearest,limit=1] at @s run function schwebebahn:vp1fahren
