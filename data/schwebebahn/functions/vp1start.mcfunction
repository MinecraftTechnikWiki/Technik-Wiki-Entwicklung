...
give @a[distance=..15] minecraft:armor_stand{EigSchwB.p1Alle:true,EigSchwB.p1Strecke:true,display:{Name:'{"text":"Transrapid-Strecke"}',Lore:['"Platziere den Rüstungsständer"','"um eine Transrapid-Strecke"','"zu erstellen"'] },EntityTag:{Tags:["EtiSchwB.p1Alle","EtiSchwB.p1Bauwerk","EtiSchwB.p1Strecke"] } }
