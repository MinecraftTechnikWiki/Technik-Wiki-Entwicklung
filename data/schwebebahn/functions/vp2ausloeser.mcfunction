...
execute unless entity @s[tag=EtiSchwB.p2SitztInLore,scores={PZSchwB.p2Ausl=0}] run tellraw @s ["Schwebebahn.erweitert.2: ",{"text":"\nfahren = ","bold":true},{"text":"wahr","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Wert wahr"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p2Ausl set 1"} },{"text":"\nfahren = ","bold":true},{"text":"falsch","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Wert falsch"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p2Ausl set 2"} },{"text":"\nfahren == ","bold":true},{"entity":"@e[distance=..2,type=minecraft:armor_stand,tag=EtiSchwB.p2Fahren,sort=nearest,limit=1]","nbt":"CustomName","interpret":true},{"text":"\nrichtungumkehren() == ","bold":true},{"text":"180°","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe um den Zug umzudrehen"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p2Ausl set 3"} } ]

execute unless entity @s[tag=EtiSchwB.p2SitztInLore,scores={PZSchwB.p2Ausl=0}] at @s run tellraw @s ["",{"text":"ansicht = ","bold":true},{"text":"Vorne","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Wert Vorne"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p2Ausl set 4"} },{"text":"\nansicht = ","bold":true},{"text":"Oben","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Wert Oben"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p2Ausl set 5"} },{"text":"\nansicht = ","bold":true},{"text":"Hinten","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Wert Hinten"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p2Ausl set 6"} },{"text":"\nansicht = ","bold":true},{"text":"Bahnsteig","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Wert Bahnsteig"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p2Ausl set 7"} },{"text":"\nansicht == ","bold":true},{"entity":"@e[distance=..2,type=minecraft:armor_stand,tag=EtiSchwB.p2Ansicht,sort=nearest,limit=1]","nbt":"CustomName","interpret":true} ]
