...
execute unless block ^ ^5 ^20 minecraft:magenta_glazed_terracotta unless block ^ ^5 ^24 minecraft:magenta_glazed_terracotta run tellraw @a[distance=..10] ["Schwebebahn1.: ",{"text":"Das Schwebebahngleis ist an dieser Stelle zu kurz!","color":"red","bold":true}]
