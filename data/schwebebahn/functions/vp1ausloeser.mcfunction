...
execute unless entity @s[tag=EtiSchwB.p1SitztInLore,scores={PZSchwB.p1Ausl=0}] run tellraw @s ["Schwebebahn.erweitert.1: ",{"text":"\nfahren = ","bold":true},{"text":"wahr","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Wert wahr"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p1Ausl set 1"} },{"text":"\nfahren = ","bold":true},{"text":"falsch","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Wert falsch"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p1Ausl set 2"} },{"text":"\nfahren == ","bold":true},{"entity":"@e[distance=..2,type=minecraft:armor_stand,tag=EtiSchwB.p1Fahren,sort=nearest,limit=1]","nbt":"CustomName","interpret":true},{"text":"\nrichtungumkehren() == ","bold":true},{"text":"180°","color":"gray","underlined":true,"bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe um den Zug umzudrehen"} },"clickEvent":{"action":"run_command","value":"/trigger PZSchwB.p1Ausl set 3"} }]
