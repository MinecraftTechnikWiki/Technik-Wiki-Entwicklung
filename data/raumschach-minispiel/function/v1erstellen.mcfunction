...
execute as @e[tag=EtiRSchMS.1Farbe,scores={PZRSchMS.1Farbe=1}] store result entity @s equipment.feet.components.minecraft:dyed_color int 1 store result entity @s equipment.legs.components.minecraft:dyed_color int 1 store result entity @s equipment.chest.components.minecraft:dyed_color int 1 store result entity @s equipment.head.components.minecraft:dyed_color int 1 run scoreboard players get KonstRSchMS.1TUERKIS PZRSchMS.1Farbe
execute as @e[tag=EtiRSchMS.1Farbe,scores={PZRSchMS.1Farbe=2}] store result entity @s equipment.feet.components.minecraft:dyed_color int 1 store result entity @s equipment.legs.components.minecraft:dyed_color int 1 store result entity @s equipment.chest.components.minecraft:dyed_color int 1 store result entity @s equipment.head.components.minecraft:dyed_color int 1 run scoreboard players get KonstRSchMS.1SCHWARZ PZRSchMS.1Farbe
execute as @e[tag=EtiRSchMS.1Farbe,scores={PZRSchMS.1Farbe=3}] store result entity @s equipment.feet.components.minecraft:dyed_color int 1 store result entity @s equipment.legs.components.minecraft:dyed_color int 1 store result entity @s equipment.chest.components.minecraft:dyed_color int 1 store result entity @s equipment.head.components.minecraft:dyed_color int 1 run scoreboard players get KonstRSchMS.1ORANGE PZRSchMS.1Farbe
