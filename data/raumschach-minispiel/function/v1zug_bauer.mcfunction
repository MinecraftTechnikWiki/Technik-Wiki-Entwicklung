...
execute positioned ^5 ^-1 ^5 if block ~ ~ ~ #raumschach-minispiel:v1schachbloecke positioned ~-0.5 ~ ~-0.5 unless score @n[dx=1,dy=4,dz=1,tag=EtiRSchMS.1Anklickbar] PZRSchMS.1Farbe = @n[tag=EtiRSchMS.1Anklickbar,tag=EtiRSchMS.1MoeglicherZug] PZRSchMS.1Farbe positioned ~0.5 ~ ~0.5 run function raumschach-minispiel:v1spielzug_anzeigen
execute positioned ^-5 ^-1 ^5 if block ~ ~ ~ #raumschach-minispiel:v1schachbloecke positioned ~-0.5 ~ ~-0.5 unless score @n[dx=1,dy=4,dz=1,tag=EtiRSchMS.1Anklickbar] PZRSchMS.1Farbe = @n[tag=EtiRSchMS.1Anklickbar,tag=EtiRSchMS.1MoeglicherZug] PZRSchMS.1Farbe positioned ~0.5 ~ ~0.5 run function raumschach-minispiel:v1spielzug_anzeigen

execute positioned ^ ^7 ^5 if block ~ ~ ~ #raumschach-minispiel:v1schachbloecke positioned ~-0.5 ~ ~-0.5 unless score @n[dx=1,dy=4,dz=1,tag=EtiRSchMS.1Anklickbar] PZRSchMS.1Farbe = @n[tag=EtiRSchMS.1Anklickbar,tag=EtiRSchMS.1MoeglicherZug] PZRSchMS.1Farbe positioned ~0.5 ~ ~0.5 run function raumschach-minispiel:v1spielzug_anzeigen
execute positioned ^ ^-9 ^5 if block ~ ~ ~ #raumschach-minispiel:v1schachbloecke positioned ~-0.5 ~ ~-0.5 unless score @n[dx=1,dy=4,dz=1,tag=EtiRSchMS.1Anklickbar] PZRSchMS.1Farbe = @n[tag=EtiRSchMS.1Anklickbar,tag=EtiRSchMS.1MoeglicherZug] PZRSchMS.1Farbe positioned ~0.5 ~ ~0.5 run function raumschach-minispiel:v1spielzug_anzeigen

execute positioned ^5 ^-1 ^ unless score @n[distance=..2,tag=EtiRSchMS.1Bauer,tag=!EtiRSchMS.1BauerDoppelZug,scores={PZRSchMS.1Spielz=2}] PZRSchMS.1Farbe = @n[tag=EtiRSchMS.1Anklickbar,tag=EtiRSchMS.1MoeglicherZug] PZRSchMS.1Farbe positioned ^ ^ ^5 run function raumschach-minispiel:v1spielzug_anzeigen
execute positioned ^-5 ^-1 ^ unless score @n[distance=..2,tag=EtiRSchMS.1Bauer,tag=!EtiRSchMS.1BauerDoppelZug,scores={PZRSchMS.1Spielz=2}] PZRSchMS.1Farbe = @n[tag=EtiRSchMS.1Anklickbar,tag=EtiRSchMS.1MoeglicherZug] PZRSchMS.1Farbe positioned ^ ^ ^5 run function raumschach-minispiel:v1spielzug_anzeigen
