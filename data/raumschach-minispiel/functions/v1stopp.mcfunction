...
clear @a minecraft:armor_stand[minecraft:custom_data~{EigRSchMS.1Alle:true}]
...
tag @e[type=minecraft:item,nbt={Item:{components:{"minecraft:custom_data":{EigRSchMS.1Alle:true} } } }] add EtiRSchMS.1Alle
