...
#execute if entity @s[tag=EtiRSchMS.1FigurenGrau] as @e[tag=EtiRSchMS.1Figur] positioned ~ ~-2 ~ if score @s PZRSchMS.1Farbe = @e[distance=..2,tag=EtiRSchMS.1Koenig,tag=EtiRSchMS.1Anklickbar,sort=nearest,limit=1] PZRSchMS.1Farbe store result entity @s ArmorItems[1].tag.display.color int 1 store result entity @s ArmorItems[2].tag.display.color int 1 store result entity @s ArmorItems[3].tag.display.color int 1 run scoreboard players get KonstRSchMS.1HELLGRAU PZRSchMS.1Farbe
