...
summon minecraft:horse ~ ~ ~ {NoAI:true,Silent:true,Tame:true,NoGravity:true,PersistenceRequired:true,DeathLootTable:"minecraft:empty",Variant:0b,Rotation:[0.0f,0.0f],Tags:["EtiRSchMS.1Alle","EtiRSchMS.1Figur","EtiRSchMS.1Springer","EtiRSchMS.1FigurBoden"],SaddleItem:{id:"minecraft:saddle",count:1},ActiveEffects:[{Id:11b,Amplifier:127b,ShowParticles:false,Duration:2147483647}],Passengers:[{id:"minecraft:zombie",NoAI:true,IsBaby:true,Silent:true,PersistenceRequired:true,CustomNameVisible:true,CustomName:'{"text":"♘","bold":true}',DeathLootTable:"minecraft:empty",Rotation:[0.0f,0.0f],Tags:["EtiRSchMS.1Alle","EtiRSchMS.1Figur","EtiRSchMS.1Anklickbar","EtiRSchMS.1Farbe","EtiRSchMS.1Springer"],HandItems:[{},{id:"minecraft:iron_sword",count:1}],ArmorItems:[{},{id:"minecraft:leather_leggings",count:1,components:{"minecraft:unbreakable":{},"minecraft:dyed_color":{rgb:16383998} } },{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:unbreakable":{},"minecraft:dyed_color":{rgb:16383998} } },{id:"minecraft:leather_helmet",count:1,components:{"minecraft:unbreakable":{},"minecraft:dyed_color":{rgb:16383998} } }]}]}
...
execute if entity @e[tag=EtiRSchMS.1Bauer,tag=EtiRSchMS.1Leuchten,sort=nearest,limit=1] as @e[distance=..2,tag=EtiRSchMS.1Farbe,tag=EtiRSchMS.1Springer,scores={PZRSchMS.1Farbe=1..},sort=nearest,limit=1] store result entity @s ArmorItems[1].components.minecraft:dyed_color.rgb int 1 store result entity @s ArmorItems[2].components.minecraft:dyed_color.rgb int 1 store result entity @s ArmorItems[3].components.minecraft:dyed_color.rgb int 1 run data get entity @e[tag=EtiRSchMS.1Bauer,tag=EtiRSchMS.1Leuchten,tag=EtiRSchMS.1Anklickbar,sort=nearest,limit=1] ArmorItems[3].components.minecraft:dyed_color.rgb 1
