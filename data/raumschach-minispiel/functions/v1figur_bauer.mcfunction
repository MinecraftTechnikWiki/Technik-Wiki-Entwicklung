...
data merge entity @e[tag=EtiRSchMS.1Bauer,tag=EtiRSchMS.1Anklickbar,sort=nearest,limit=1] {CustomNameVisible:true,CustomName:'{"text":"♙","bold":true}',HandItems:[{},{id:"minecraft:iron_hoe",count:1}],ArmorItems:[{},{id:"minecraft:leather_leggings",count:1,components:{"minecraft:unbreakable":true,"minecraft:dyed_color":{rgb:16383998} } },{id:"minecraft:leather_chestplate",count:1,components:{"minecraft:unbreakable":true,"minecraft:dyed_color":{rgb:16383998} } },{id:"minecraft:leather_helmet",count:1,components:{"minecraft:unbreakable":true,"minecraft:dyed_color":{rgb:16383998} } } ] }
...
data merge entity @e[distance=..3,tag=EtiRSchMS.1Bauer,tag=EtiRSchMS.1Farbe,scores={PZRSchMS.1Farbe=1},sort=nearest,limit=1] {Color:9b}
data merge entity @e[distance=..3,tag=EtiRSchMS.1Bauer,tag=EtiRSchMS.1Farbe,scores={PZRSchMS.1Farbe=2},sort=nearest,limit=1] {Color:15b}
data merge entity @e[distance=..3,tag=EtiRSchMS.1Bauer,tag=EtiRSchMS.1Farbe,scores={PZRSchMS.1Farbe=3},sort=nearest,limit=1] {Color:1b}
