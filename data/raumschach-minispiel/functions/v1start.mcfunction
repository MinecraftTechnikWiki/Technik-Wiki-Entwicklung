...
give @p[distance=..15] minecraft:armor_stand{EigRSchMS.1Alle:true,Enchantments:[{id:-1}],display:{Name:'{"text":"Raumschach"}',Lore:['"Platziere den Rüstungsständer"','"um ein 3D-Schachfeld zu"','"erzeugen"']},EntityTag:{Marker:true,Tags:["EtiRSchMS.1Alle","EtiRSchMS.1SchachbrettErstellen"] } }
