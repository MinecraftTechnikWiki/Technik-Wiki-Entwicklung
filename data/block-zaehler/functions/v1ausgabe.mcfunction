...
$tellraw @s [{"storage":"block-zaehler:v1daten","nbt":"\"EigBlZal.1Liste\"[-1].Anzahl","color":"dark_purple","bold":true}," {{BL|",{"translate":"block.minecraft.$(Block)","color":"gold","bold":true},"} } "]
