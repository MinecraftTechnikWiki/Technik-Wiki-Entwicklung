...
execute if score VarBlZal.1Bereich PZBlZal.1Wert matches 0 run tellraw @s ["Block-Zähler.1:\n",{text:"Der Bereich in dem Blöcke gezählt werden sollen, ist zu klein!",color:"red",bold:true}]
...
execute store result entity @n[type=minecraft:marker,tag=EtiBlZal.1Start] Pos[0] double 1 store result storage block-zaehler:v1daten "EigBlZal.1Position".X int 1 run scoreboard players get VarBlZal.1X PZBlZal.1Wert
execute store result entity @n[type=minecraft:marker,tag=EtiBlZal.1Start] Pos[1] double 1 store result storage block-zaehler:v1daten "EigBlZal.1Position".Y int 1 run scoreboard players get VarBlZal.1Y PZBlZal.1Wert
execute store result entity @n[type=minecraft:marker,tag=EtiBlZal.1Start] Pos[2] double 1 store result storage block-zaehler:v1daten "EigBlZal.1Position".Z int 1 run scoreboard players get VarBlZal.1Z PZBlZal.1Wert
...
execute store result entity @n[type=minecraft:marker,tag=EtiBlZal.1Ende] Pos[0] double 1 run scoreboard players add VarBlZal.1DX PZBlZal.1Wert 1
execute store result entity @n[type=minecraft:marker,tag=EtiBlZal.1Ende] Pos[1] double 1 run scoreboard players add VarBlZal.1DY PZBlZal.1Wert 1
execute store result entity @n[type=minecraft:marker,tag=EtiBlZal.1Ende] Pos[2] double 1 run scoreboard players add VarBlZal.1DZ PZBlZal.1Wert 1
