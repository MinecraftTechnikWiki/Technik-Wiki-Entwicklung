...
tellraw @s ["Block-Zähler.1:\n",{text:"bereich.start = ",bold:true},{text:"Spieler.position()",color:"gray",underlined:true,bold:true,hover_event:{action:"show_text",value:{text:"Tippe für die erste Position des Spielers"} },click_event:{action:"run_command",command:"/trigger PZBlZal.1Ausl set 1"} },"\n",{text:"bereich.start == ",bold:true},{storage:"block-zaehler:v1daten",nbt:'"EigBlZal.1Start"',color:"dark_purple",bold:true},"\n",{text:"bereich.ende = ",bold:true},{text:"Spieler.position()",color:"gray",underlined:true,bold:true,hover_event:{action:"show_text",value:{text:"Tippe für die zweite Position des Spielers"} },click_event:{action:"run_command",command:"/trigger PZBlZal.1Ausl set 2"} },"\n",{text:"bereich.ende == ",bold:true},{storage:"block-zaehler:v1daten",nbt:'"EigBlZal.1Ende"',color:"dark_purple",bold:true},"\n",{text:"bereich.luft {",bold:true},{text:"NICHT luft",color:"gray",underlined:true,bold:true,hover_event:{action:"show_text",value:{text:"Tippe um Luft zu negieren"} },click_event:{action:"run_command",command:"/trigger PZBlZal.1Ausl set 3"} },{text:"} == ",bold:true},{storage:"block-zaehler:v1daten",nbt:'"EigBlZal.1Luft"[0]',interpret:true},"\n",{text:"bereich.zaehlen()",color:"gray",underlined:true,bold:true,hover_event:{action:"show_text",value:{text:"Tippe um Blöcke zu zählen"} },click_event:{action:"run_command",command:"/trigger PZBlZal.1Ausl set 4"} } ]
