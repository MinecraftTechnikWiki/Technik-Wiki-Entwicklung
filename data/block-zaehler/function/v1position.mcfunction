...
execute if score VarBlZal.1Liste PZBlZal.1Wert matches 0 run tellraw @s ["Block-Zähler.1:\n",{text:"Keine Blöcke im Bereich gefunden!",color:"red",bold:true}]
