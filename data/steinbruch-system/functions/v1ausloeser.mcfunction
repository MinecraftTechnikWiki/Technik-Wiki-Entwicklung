...
tellraw @s ["Steinbruch-System.1:\n",{"text":"groesse = ","bold":true},{"text":"groesse + 1","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Größe + 1"} },"clickEvent":{"action":"run_command","value":"/trigger PZStBrSy.1Ausl set 1"} },"\n",{"text":"groesse = ","bold":true},{"text":"groesse - 1","color":"gray","bold":true,"underlined":true,"hoverEvent":{"action":"show_text","contents":{"text":"Tippe für Größe - 1"} },"clickEvent":{"action":"run_command","value":"/trigger PZStBrSy.1Ausl set -1"} },"\n",{"text":"groesse == ","bold":true},{"score":{"name":"VarStBrSy.1Groesse","objective":"PZStBrSy.1Ausl"},"color":"dark_purple","bold":true} ]
