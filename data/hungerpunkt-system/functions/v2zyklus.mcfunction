...
execute at @a[scores={PZHungS.2Trinken=100..}] run particle minecraft:dripping_water ~ ~1 ~ 0.2 0.4 0.2 0.3 100 force @a[distance=..25]
...
title @a[tag=!EtiHungS.2HaelfteWasser,scores={PZHungS.2Trinken=49..51}] actionbar ["",{"text":"Dein Wasservorrat ist bei der Hälfte!","color":"dark_red","bold":true}]
