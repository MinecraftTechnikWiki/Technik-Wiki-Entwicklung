...
tellraw @s ["Transport-Röhre.1: ",{"text":"\nlaenge = ","bold":true},{"text":"laenge + 1","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Länge + 1"} },"clickEvent":{"action":"run_command","value":"/trigger PZTranPR.1Ausl set 1"} },{"text":"\nlaenge = ","bold":true},{"text":"laenge - 1","color":"gray","bold":true,"hoverEvent":{"action":"show_text","value":{"text":"Tippe für Länge - 1"} },"clickEvent":{"action":"run_command","value":"/trigger PZTranPR.1Ausl set -1"} },{"text":"\nlaenge == ","bold":true},{"score":{"name":"VarTranPR.1Laenge","objective":"PZTranPR.1Ausl"},"color":"dark_purple","bold":true}]
