...
execute if entity @s[team=TMTowDefMS.1Team1] if entity @e[distance=..2,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Wert=1,PZTowDefMS.1Versuch=..0},sort=nearest,limit=1] run function tower-defense-minispiel:v1verloren
execute if entity @s[team=TMTowDefMS.1Team2] if entity @e[distance=..2,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Wert=2,PZTowDefMS.1Versuch=..0},sort=nearest,limit=1] run function tower-defense-minispiel:v1verloren

execute if entity @s[gamemode=creative] run function tower-defense-minispiel:v1verloren

execute if block ~ ~-1 ~ minecraft:orange_concrete run effect give @s minecraft:levitation 1 30 true
