...
execute at @e[type=minecraft:text_display,tag=EtiTowDefMS.1Teleporter,sort=nearest,limit=1] run particle minecraft:portal ~ ~-3 ~ 0 1 0 0.7 35 force @a[distance=..15]

execute if score VarTowDefMS.1Teilnehmer PZTowDefMS.1Wert matches 10 at @e[type=minecraft:text_display,tag=EtiTowDefMS.1Teleporter,sort=nearest,limit=1] positioned ~ ~-3 ~ run title @a[distance=..3] actionbar ["",{"text":"Lobby ist voll","color":"red","bold":true}]
execute if score VarTowDefMS.1Teilnehmer PZTowDefMS.1Wert matches ..9 at @e[type=minecraft:text_display,tag=EtiTowDefMS.1Teleporter,sort=nearest,limit=1] positioned ~ ~-3 ~ as @p[distance=..3,gamemode=!spectator] run function tower-defense-minispiel:v1beitreten

execute if score VarTowDefMS.1Wartende PZTowDefMS.1Wert matches 1.. as @e[type=minecraft:interaction,tag=EtiTowDefMS.1Wartesaal,sort=nearest,limit=1] store success score @s PZTowDefMS.1Wert if data entity @s interaction
execute if score VarTowDefMS.1Wartende PZTowDefMS.1Wert matches 1.. as @e[type=minecraft:interaction,tag=EtiTowDefMS.1Wartesaal,scores={PZTowDefMS.1Wert=1},sort=nearest,limit=1] on target run tag @s[team=TMTowDefMS.1Lobby,nbt={SelectedItem:{id:"minecraft:red_bed",components:{"minecraft:custom_data":{EigTowDefMS.1Verlassen:true} } } }] add EtiTowDefMS.1Verlassen
execute if score VarTowDefMS.1Wartende PZTowDefMS.1Wert matches 1.. run data remove entity @e[type=minecraft:interaction,tag=EtiTowDefMS.1Wartesaal,scores={PZTowDefMS.1Wert=1},sort=nearest,limit=1] interaction
...
execute if score VarTowDefMS.1Spielende PZTowDefMS.1Wert matches 0 at @e[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld,sort=nearest,limit=1] run function tower-defense-minispiel:v1spielfeld
execute if score VarTowDefMS.1Spielende PZTowDefMS.1Wert matches 0 at @e[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld,sort=nearest,limit=1] as @a[distance=..100,tag=EtiTowDefMS.1Spielen,tag=!EtiTowDefMS.1Verloren] at @s run function tower-defense-minispiel:v1spielen
...
execute at @e[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld,sort=nearest,limit=1] as @a[distance=..100,team=!] unless entity @s[team=!TMTowDefMS.1Lobby,tag=!EtiTowDefMS.1Spielen] positioned ~-35 ~-1 ~-35 unless entity @s[dx=70,dy=50,dz=70] run function tower-defense-minispiel:v1verlassen

execute at @e[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld,sort=nearest,limit=1] as @a[distance=..100,team=!TMTowDefMS.1Lobby,tag=!EtiTowDefMS.1Spielen] positioned ~-35 ~-1 ~-35 if entity @s[dx=70,dy=50,dz=70] run function tower-defense-minispiel:v1verlassen
...
execute store result bossbar tower-defense-minispiel:v1team1 value run scoreboard players operation VarTowDefMS.1Team1 PZTowDefMS.1Wert = @e[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Wert=1},sort=nearest,limit=1] PZTowDefMS.1Versuch
...
execute store result bossbar tower-defense-minispiel:v1team2 value run scoreboard players operation VarTowDefMS.1Team2 PZTowDefMS.1Wert = @e[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Wert=2},sort=nearest,limit=1] PZTowDefMS.1Versuch
...
execute at @e[type=minecraft:interaction,tag=EtiTowDefMS.1Wartesaal,sort=nearest,limit=1] as @a[distance=..100,team=TMTowDefMS.1Lobby] run function tower-defense-minispiel:v1auswahl
...
data modify entity @e[distance=..15,type=minecraft:text_display,tag=EtiTowDefMS.1Teleporter,sort=nearest,limit=1] text set value '["",{"text":"Lobby","color":"yellow","bold":true},"\\n",{"score":{"name":"VarTowDefMS.1Teilnehmer","objective":"PZTowDefMS.1Wert"},"color":"dark_purple","bold":true},{"text":"/","bold":true},{"text":"10","color":"dark_purple","bold":true}]'

execute at @e[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld,sort=nearest,limit=1] as @e[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,sort=nearest,limit=2] run data modify entity @s text set value '["",{"text":"Leben","color":"yellow","bold":true},"\\n",{"score":{"name":"@s","objective":"PZTowDefMS.1Versuch"},"color":"dark_purple","bold":true},{"text":"/","bold":true},{"text":"100","color":"dark_purple","bold":true}]'

execute if score VarTowDefMS.1Wartende PZTowDefMS.1Wert matches 1.. as @e[type=minecraft:interaction,tag=EtiTowDefMS.1Wartesaal,sort=nearest,limit=1] at @s run function tower-defense-minispiel:v1warten

execute if score VarTowDefMS.1Zaehlen PZTowDefMS.1Wert matches 1 at @e[type=minecraft:interaction,tag=EtiTowDefMS.1Wartesaal,sort=nearest,limit=1] as @e[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld,sort=nearest,limit=1] run function tower-defense-minispiel:v1spielstart with entity @s data."EigTowDefMS.1Argumente"

execute if score VarTowDefMS.1Spielen PZTowDefMS.1Wert matches 1 if score VarTowDefMS.1Spielende PZTowDefMS.1Wert matches 1 at @e[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld,sort=nearest,limit=1] run function tower-defense-minispiel:v1spielende
...
execute at @e[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld,sort=nearest,limit=1] as @e[distance=..100,type=minecraft:text_display,tag=EtiTowDefMS.1Leiste] on vehicle on passengers run tag @s[type=minecraft:text_display,tag=EtiTowDefMS.1Leiste] add EtiTowDefMS.1NichtAlleine
execute at @e[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld,sort=nearest,limit=1] run kill @e[distance=..100,type=minecraft:text_display,tag=EtiTowDefMS.1Leiste,tag=!EtiTowDefMS.1NichtAlleine]
execute at @e[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld,sort=nearest,limit=1] run tag @e[distance=..100,type=minecraft:text_display,tag=EtiTowDefMS.1Leiste,tag=EtiTowDefMS.1NichtAlleine] remove EtiTowDefMS.1NichtAlleine
