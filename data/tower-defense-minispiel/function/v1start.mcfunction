...
summon minecraft:area_effect_cloud ~ ~ ~ {Duration:400,custom_particle:{type:"minecraft:block",block_state:"minecraft:air"},Radius:0.0f,Tags:["EtiTowDefMS.1Start"]}
...
execute at @n[type=minecraft:text_display,tag=EtiTowDefMS.1Teleporter] run place template tower-defense-minispiel:v1teleporter ~-8 ~-3 ~-9 none
...
execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run place template tower-defense-minispiel:v1gebiet1 ~-32 ~ ~-15 none
execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run place template tower-defense-minispiel:v1gebiet2 ~-15 ~ ~-32 none

#execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run place template tower-defense-minispiel:v1gebiet1 ~1 ~ ~1 none
#xecute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run place template tower-defense-minispiel:v1gebiet2 ~ ~ ~1 clockwise_90
#xecute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run place template tower-defense-minispiel:v1gebiet1 ~ ~ ~ 180
#execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run place template tower-defense-minispiel:v1gebiet2 ~1 ~ ~ counterclockwise_90

execute as @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] store result score @s PZTowDefMS.1Wert run data get entity @s Pos[1]
execute as @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] store result entity @s data."EigTowDefMS.1Argumente".Y int 1 run scoreboard players add @s PZTowDefMS.1Wert 10



execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run summon minecraft:text_display ~-22 ~3 ~-8 {Rotation:[0.0f,0.0f],Tags:["EtiTowDefMS.1Alle","EtiTowDefMS.1Startpunkt"],text:["",{text:"Leben",color:"yellow",bold:true},"\n",{text:"100",color:"dark_purple",bold:true},{text:"/",bold:true},{text:"100",color:"dark_purple",bold:true}]}
scoreboard players set @n[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt] PZTowDefMS.1Wert 1
#execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] positioned ~-22 ~3 ~-8 run scoreboard players set @n[distance=..1,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt] PZTowDefMS.1Wert 1

execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run summon minecraft:text_display ~-8 ~3 ~-22 {Rotation:[-90.0f,0.0f],Tags:["EtiTowDefMS.1Alle","EtiTowDefMS.1Startpunkt"],text:["",{text:"Leben",color:"yellow",bold:true},"\n",{text:"100",color:"dark_purple",bold:true},{text:"/",bold:true},{text:"100",color:"dark_purple",bold:true}]}
scoreboard players add @e[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,sort=nearest,limit=2] PZTowDefMS.1Wert 1
#execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] positioned ~-8 ~3 ~-22 run scoreboard players set @n[distance=..1,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt] PZTowDefMS.1Wert 2
#scoreboard players add @e[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,sort=nearest,limit=2] PZTowDefMS.1Wert 1


#execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] as @e[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,sort=nearest,limit=2] store result score @s PZTowDefMS.1Wert run scoreboard players add @n[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt] PZTowDefMS.1Wert 1

#execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run summon minecraft:text_display ~24 ~3 ~-24 {Rotation:[90.0f,0.0f],Tags:["EtiTowDefMS.1Alle","EtiTowDefMS.1Startpunkt"],text:["",{text:"Leben",color:"yellow",bold:true},"\n",{text:"100",color:"dark_purple",bold:true},{text:"/",bold:true},{text:"100",color:"dark_purple",bold:true}]}
#scoreboard players set @n[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt] PZTowDefMS.1Wert 1
#execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run summon minecraft:text_display ~-23 ~3 ~25 {Rotation:[-90.0f,0.0f],Tags:["EtiTowDefMS.1Alle","EtiTowDefMS.1Startpunkt"],text:["",{text:"Leben",color:"yellow",bold:true},"\n",{text:"100",color:"dark_purple",bold:true},{text:"/",bold:true},{text:"100",color:"dark_purple",bold:true}]}
...
execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run summon minecraft:marker ~-23 ~31.5 ~-10 {Rotation:[0.0f,0.0f],Tags:["EtiTowDefMS.1Alle","EtiTowDefMS.1Wellen"]}
scoreboard players set @n[type=minecraft:marker,tag=EtiTowDefMS.1Wellen] PZTowDefMS.1Wert 1

execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run summon minecraft:marker ~-10 ~31.5 ~-23 {Rotation:[-90.0f,0.0f],Tags:["EtiTowDefMS.1Alle","EtiTowDefMS.1Wellen"]}
...
#execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run summon minecraft:marker ~-5 ~23.5 ~-20 {Rotation:[90.0f,0.0f],Tags:["EtiTowDefMS.1Alle","EtiTowDefMS.1Wellen"],data:{EigTowDefMS.1Mannschaft:2} }
#scoreboard players add @e[type=minecraft:marker,tag=EtiTowDefMS.1Wellen,sort=furthest,limit=2] PZTowDefMS.1Wert 1

#execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run summon minecraft:marker ~6 ~23.5 ~21 {Rotation:[-90.0f,0.0f],Tags:["EtiTowDefMS.1Alle","EtiTowDefMS.1Wellen"]}
#scoreboard players set @n[type=minecraft:marker,tag=EtiTowDefMS.1Wellen] PZTowDefMS.1Wert 1

#execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run summon minecraft:marker ~-5 ~23.5 ~-20 {Rotation:[90.0f,0.0f],Tags:["EtiTowDefMS.1Alle","EtiTowDefMS.1Wellen"]}
#scoreboard players add @e[type=minecraft:marker,tag=EtiTowDefMS.1Wellen,sort=furthest,limit=2] PZTowDefMS.1Wert 1

execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run summon minecraft:interaction ~ ~40.5 ~ {width:21,height:3,Tags:["EtiTowDefMS.1Alle","EtiTowDefMS.1Wartesaal"]}
execute at @n[type=minecraft:interaction,tag=EtiTowDefMS.1Wartesaal] run place template tower-defense-minispiel:v1wartesaal ~-11 ~-1 ~-11 none

execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] positioned ~-35 ~-1 ~-35 as @a[dx=70,dy=50,dz=70] at @s run function tower-defense-minispiel:v1verlassen
