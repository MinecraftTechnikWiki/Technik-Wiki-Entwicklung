...
execute at @n[type=minecraft:marker,tag=EtiTowDefMS.1Spielfeld] run clear @a[distance=..100,tag=EtiTowDefMS.1Spielen] minecraft:golden_shovel[minecraft:custom_data~{EigTowDefMS.1Alle:true}]
