...
item replace entity @a[team=TMTowDefMS.1Team1] armor.head with minecraft:leather_helmet[minecraft:enchantments={"minecraft:binding_curse":1},minecraft:tooltip_display={hidden_components:["minecraft:enchantments","minecraft:dyed_color"]},minecraft:custom_data={EigTowDefMS.1Alle:true},minecraft:dyed_color=16711680]
item replace entity @a[team=TMTowDefMS.1Team2] armor.head with minecraft:leather_helmet[minecraft:enchantments={"minecraft:binding_curse":1},minecraft:tooltip_display={hidden_components:["minecraft:enchantments","minecraft:dyed_color"]},minecraft:custom_data={EigTowDefMS.1Alle:true},minecraft:dyed_color=255]
...
$execute at @n[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Wert=1}] positioned ^ ^ ^10 run spreadplayers ~ ~ 1 2 under $(Y) false @a[distance=..50,team=TMTowDefMS.1Team1]
$execute at @n[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Wert=2}] positioned ^ ^ ^10 run spreadplayers ~ ~ 1 2 under $(Y) false @a[distance=..50,team=TMTowDefMS.1Team2]

give @a[tag=EtiTowDefMS.1Spielen] minecraft:wooden_sword[minecraft:lore=["Nutze dieses Schwert","um beim Tower-Defense alle","Gegner im Notfall","direkt zu besiegen!"],minecraft:attribute_modifiers=[{amount:-1,operation:"add_value",slot:"mainhand",type:"minecraft:attack_damage",id:"tower-defense-minispiel:v1werkzeug"}],minecraft:enchantments={"minecraft:efficiency":10,"minecraft:unbreaking":10},minecraft:unbreakable={},minecraft:custom_name={text:"Tower-Defense-Schwert",bold:true},minecraft:tooltip_display={hidden_components:["minecraft:attribute_modifiers","minecraft:enchantments","minecraft:unbreakable"]},minecraft:custom_data={EigTowDefMS.1Alle:true}]

give @a[tag=EtiTowDefMS.1Spielen] minecraft:bow[minecraft:lore=["Nutze diesen Bogen","um beim Tower-Defense alle","Gegner im Notfall","direkt zu besiegen!"],minecraft:attribute_modifiers=[{amount:-1,operation:"add_value",slot:"mainhand",type:"minecraft:attack_damage",id:"tower-defense-minispiel:v1werkzeug"}],minecraft:enchantments={"minecraft:infinity":10,"minecraft:unbreaking":10},minecraft:unbreakable={},minecraft:custom_name={text:"Tower-Defense-Bogen",bold:true},minecraft:tooltip_display={hidden_components:["minecraft:attribute_modifiers","minecraft:enchantments","minecraft:unbreakable"]},minecraft:custom_data={EigTowDefMS.1Alle:true}]
