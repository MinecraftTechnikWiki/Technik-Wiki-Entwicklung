...
item replace entity @a[team=TMTowDefMS.1Lobby] hotbar.8 with minecraft:red_banner[minecraft:enchantments={"minecraft:binding_curse":1},minecraft:custom_name={text:"Rote Mannschaft",color:"red",bold:true},minecraft:tooltip_display={hidden_components:["minecraft:enchantments"]},minecraft:custom_data={EigTowDefMS.1Alle:true,EigTowDefMS.1Team:1}]
item replace entity @a[team=TMTowDefMS.1Lobby] hotbar.7 with minecraft:blue_banner[minecraft:enchantments={"minecraft:binding_curse":1},minecraft:custom_name={text:"Blaue Mannschaft",color:"blue",bold:true},minecraft:tooltip_display={hidden_components:["minecraft:enchantments"]},minecraft:custom_data={EigTowDefMS.1Alle:true,EigTowDefMS.1Team:2}]
