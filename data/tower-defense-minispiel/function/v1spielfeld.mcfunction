...
execute as @e[type=minecraft:item_display,tag=EtiTowDefMS.1Schuetze] at @s facing entity @n[distance=..10,tag=EtiTowDefMS.1Gegner] feet run teleport @s ~ ~ ~ ~ ~ 

execute as @e[type=minecraft:item_display,tag=EtiTowDefMS.1Geschoss,tag=EtiTowDefMS.1Geschossen,scores={PZTowDefMS.1Leben=1}] at @s store success score @s PZTowDefMS.1Versuch run damage @n[distance=..2,tag=EtiTowDefMS.1Gegner] 3 minecraft:arrow

execute as @e[type=minecraft:item_display,tag=EtiTowDefMS.1Geschoss,tag=EtiTowDefMS.1Geschossen,scores={PZTowDefMS.1Leben=2}] at @s store success score @s PZTowDefMS.1Versuch run damage @n[distance=..2,tag=EtiTowDefMS.1Gegner] 7 minecraft:arrow

execute as @e[type=minecraft:item_display,tag=EtiTowDefMS.1Geschoss,tag=EtiTowDefMS.1Geschossen,scores={PZTowDefMS.1Leben=3}] at @s store success score @s PZTowDefMS.1Versuch run damage @n[distance=..2,tag=EtiTowDefMS.1Gegner] 11 minecraft:arrow
...
execute as @e[type=minecraft:item_display,tag=EtiTowDefMS.1Schuetze,scores={PZTowDefMS.1Leben=20..}] at @s if entity @n[distance=..10,tag=EtiTowDefMS.1Gegner] run summon minecraft:item_display ~ ~ ~ {item:{id:"minecraft:arrow",count:1},Tags:["EtiTowDefMS.1Alle","EtiTowDefMS.1Geschoss"]}

execute as @e[type=minecraft:item_display,tag=EtiTowDefMS.1Geschoss,tag=!EtiTowDefMS.1Geschossen] at @s positioned ~ ~-4 ~ run scoreboard players operation @s PZTowDefMS.1Leben = @n[distance=..2,type=minecraft:marker,tag=EtiTowDefMS.1Schiessturm] PZTowDefMS.1Leben

execute as @e[type=minecraft:item_display,tag=EtiTowDefMS.1Geschoss,tag=!EtiTowDefMS.1Geschossen] at @s facing entity @n[distance=..10,tag=EtiTowDefMS.1Gegner] feet run teleport @s ~ ~ ~ ~ ~ 
...
execute at @e[type=minecraft:block_display,tag=EtiTowDefMS.1Gefrieren,scores={PZTowDefMS.1Versuch=100..}] run tag @n[distance=..1,tag=EtiTowDefMS.1Gegner,tag=EtiTowDefMS.1Gefroren] remove EtiTowDefMS.1Gefroren
...
execute as @e[type=minecraft:item_display,tag=EtiTowDefMS.1Explosion,scores={PZTowDefMS.1Versuch=1}] at @s positioned ~ ~-4 ~ if entity @n[distance=..2,type=minecraft:marker,tag=EtiTowDefMS.1TNTTurm,scores={PZTowDefMS.1Leben=1}] as @e[distance=..10,tag=EtiTowDefMS.1Gegner] run damage @s 20 minecraft:explosion

execute as @e[type=minecraft:item_display,tag=EtiTowDefMS.1Explosion,scores={PZTowDefMS.1Versuch=1}] at @s positioned ~ ~-4 ~ if entity @n[distance=..2,type=minecraft:marker,tag=EtiTowDefMS.1TNTTurm,scores={PZTowDefMS.1Leben=2}] as @e[distance=..10,tag=EtiTowDefMS.1Gegner] run damage @s 35 minecraft:explosion

execute as @e[type=minecraft:item_display,tag=EtiTowDefMS.1Explosion,scores={PZTowDefMS.1Versuch=1}] at @s positioned ~ ~-4 ~ if entity @n[distance=..2,type=minecraft:marker,tag=EtiTowDefMS.1TNTTurm,scores={PZTowDefMS.1Leben=2}] as @e[distance=..10,tag=EtiTowDefMS.1Gegner] run damage @s 45 minecraft:explosion

execute at @e[type=minecraft:item_display,tag=EtiTowDefMS.1Explosion,scores={PZTowDefMS.1Versuch=1}] as @n[distance=..2,type=minecraft:text_display,tag=EtiTowDefMS.1Aufladen] store success score @s PZTowDefMS.1Versuch positioned ~ ~-6 ~ as @n[distance=..1,type=minecraft:marker,tag=EtiTowDefMS.1TNTTurm] at @s store success score @s PZTowDefMS.1Versuch run fill ~-1 ~ ~-1 ~1 ~6 ~1 minecraft:air replace
...
execute as @e[distance=..100,type=minecraft:snowball,tag=EtiTowDefMS.1Ball,scores={PZTowDefMS.1Wert=1..}] at @s as @n[distance=..3,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Versuch=1..}] if score @s PZTowDefMS.1Wert = @n[distance=..0.5,type=minecraft:snowball,tag=EtiTowDefMS.1Ball] PZTowDefMS.1Wert store success score @n[distance=..0.5,type=minecraft:snowball,tag=EtiTowDefMS.1Ball] PZTowDefMS.1Versuch run tag @s add EtiTowDefMS.1Heilen

execute if score VarTowDefMS.1Punkte1 PZTowDefMS.1Wert matches 5.. run scoreboard players add @n[distance=..100,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,tag=EtiTowDefMS.1Heilen,scores={PZTowDefMS.1Wert=1,PZTowDefMS.1Versuch=1..}] PZTowDefMS.1Versuch 1
execute if score VarTowDefMS.1Punkte2 PZTowDefMS.1Wert matches 5.. run scoreboard players add @n[distance=..100,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,tag=EtiTowDefMS.1Heilen,scores={PZTowDefMS.1Wert=2,PZTowDefMS.1Versuch=1..}] PZTowDefMS.1Versuch 1

execute if score VarTowDefMS.1Punkte1 PZTowDefMS.1Wert matches 5.. if entity @n[distance=..100,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,tag=EtiTowDefMS.1Heilen,scores={PZTowDefMS.1Wert=1}] run scoreboard players remove VarTowDefMS.1Punkte1 PZTowDefMS.1Wert 5
execute if score VarTowDefMS.1Punkte2 PZTowDefMS.1Wert matches 5.. if entity @n[distance=..100,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,tag=EtiTowDefMS.1Heilen,scores={PZTowDefMS.1Wert=2}] run scoreboard players remove VarTowDefMS.1Punkte2 PZTowDefMS.1Wert 5
...
#execute as @e[tag=EtiTowDefMS.1Gegner] at @s if entity @n[distance=..0.5,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Versuch=1..}]

execute as @e[tag=EtiTowDefMS.1Gegner,tag=!EtiTowDefMS.1Gefroren] at @s store success score @s PZTowDefMS.1Versuch run scoreboard players remove @n[distance=..1.75,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Versuch=1..}] PZTowDefMS.1Versuch 1
kill @e[tag=EtiTowDefMS.1Gegner,tag=!EtiTowDefMS.1Gefroren,scores={PZTowDefMS.1Versuch=1}]

#execute as @e[tag=EtiTowDefMS.1Gegner] at @s unless block ~ ~ ~ minecraft:air run scoreboard players remove @n[distance=..5,type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Versuch=1..}] PZTowDefMS.1Versuch 1
...
#scoreboard players set @n[distance=..1,tag=EtiTowDefMS.1Gegner,y_rotation=135.0..-135.0] PZTowDefMS.1Richtung 0
#scoreboard players set @n[distance=..1,tag=EtiTowDefMS.1Gegner,y_rotation=-135.0..-45.0] PZTowDefMS.1Richtung 1
#scoreboard players set @n[distance=..1,tag=EtiTowDefMS.1Gegner,y_rotation=-45.0..45.0] PZTowDefMS.1Richtung 2
#scoreboard players set @n[distance=..1,tag=EtiTowDefMS.1Gegner,y_rotation=45.0..135.0] PZTowDefMS.1Richtung 3
