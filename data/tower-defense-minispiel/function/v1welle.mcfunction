...
execute store result bossbar tower-defense-minispiel:v1team1 value run scoreboard players get @n[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Wert=1}] PZTowDefMS.1Versuch

execute store result bossbar tower-defense-minispiel:v1team2 value run scoreboard players get @n[type=minecraft:text_display,tag=EtiTowDefMS.1Startpunkt,scores={PZTowDefMS.1Wert=2}] PZTowDefMS.1Versuch
