...
execute if entity @s[tag=EtiZaRezM.1Zauberbuch] store result score VarZaRezM.1AnzahlVerzauberung PZZaRezM.1Wert run data remove block ~ ~ ~ Items[{Slot:0b}].components.minecraft:stored_enchantments
