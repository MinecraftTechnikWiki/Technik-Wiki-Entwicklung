...
#execute if entity @s[tag=!EtiZaRezM.1Zauberbuch] run data modify storage zaubertisch-rezeptmaschine:v1daten "EigZaRezM.1NeuerZauber" set value {id:"minecraft:enchanted_book",Count:1b}
...
execute if entity @s[tag=EtiZaRezM.1Zauberbuch] store result score VarZaRezM.1AnzahlVerzauberung PZZaRezM.1Wert run data remove block ~ ~ ~ Items[{Slot:0b}].tag.StoredEnchantments
...
#execute if entity @s[tag=EtiZaRezM.1Zauberbuch,tag=!EtiZaRezM.1Gefunden] run data modify storage zaubertisch-rezeptmaschine:v1daten "EigZaRezM.1ZauberSpeicher" append from block ~ ~ ~ Items[{Slot:0b}].tag.StoredEnchantments[0]
#execute if entity @s[tag=EtiZaRezM.1Zauberbuch,tag=!EtiZaRezM.1Gefunden] run data remove block ~ ~ ~ Items[{Slot:0b}].tag.StoredEnchantments[0]
...
#execute store result score VarZaRezM.1Zufallszahl PZZaRezM.1Wert run data get entity @e[type=minecraft:area_effect_cloud,tag=EtiZaRezM.1Alle,sort=nearest,limit=1] UUID[0]
