...
#execute at @a as @e[distance=..5,type=minecraft:item_frame,tag=EtiZaRezM.1Spender,sort=nearest,limit=1] at @s unless block ~ ~-1 ~ minecraft:dropper[facing=up] run kill @s
