...
execute if entity @s[tag=EtiZaRezM.1Zauberbuch,tag=!EtiZaRezM.1Gefunden] store success score VarZaRezM.1Ungleich PZZaRezM.1Wert run data modify storage zaubertisch-rezeptmaschine:v1daten "EigZaRezM.1NeuerZauber".id set from block ~ ~ ~ Items[{Slot:0b}].tag.StoredEnchantments[0].id
...
execute if entity @s[tag=EtiZaRezM.1Zauberbuch,tag=!EtiZaRezM.1Gefunden,tag=!EtiZaRezM.1StufeGroesser] if score VarZaRezM.1Ungleich PZZaRezM.1Wert matches 0 store result score VarZaRezM.1NeueStufe PZZaRezM.1Wert run data get block ~ ~ ~ Items[{Slot:0b}].tag.StoredEnchantments[0].lvl
...
execute if entity @s[tag=!EtiZaRezM.1Zauberbuch] if score VarZaRezM.1Position PZZaRezM.1Wert = VarZaRezM.1Zufallszahl PZZaRezM.1Wert run data modify storage zaubertisch-rezeptmaschine:v1daten "EigZaRezM.1NeuerZauber".tag.StoredEnchantments[0] set from storage zaubertisch-rezeptmaschine:v1daten "EigZaRezM.1Zauber"[0]
