...
execute store result score VarZaRezM.1Zufallszahl PZZaRezM.1Wert run data get entity @n[type=minecraft:area_effect_cloud,tag=EtiZaRezM.1Zufall] UUID[0]
...
scoreboard players operation VarZaRezM.1Zutat PZZaRezM.1Mat = @s PZZaRezM.1Mat

execute if entity @s[tag=EtiZaRezM.1Zutat] run function braustand-rezeptmaschine:v2zutaten

execute if score VarZaRezM.1Zutat PZZaRezM.1Mat matches 1.. unless score VarZaRezM.1Zutat PZZaRezM.1Mat = @s PZZaRezM.1Mat run scoreboard players set VarZaRezM.1Traenke PZZaRezM.1Fort 0
...
execute if entity @s[tag=EtiZaRezM.1Zutat,scores={PZZaRezM.1Mat=1..}] if score VarZaRezM.1Traenke PZZaRezM.1Fort matches 1.. run function zaubertisch-rezeptmaschine:v1rezeptblock
