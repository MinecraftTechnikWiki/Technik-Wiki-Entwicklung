...
execute if score VarLagerM.1Ungleich PZLagerM.1Ausl matches 0 store success score VarLagerM.1GUI PZLagerM.1Ausl if data entity @s Items[{Slot:10b}].tag
execute if score VarLagerM.1Ungleich PZLagerM.1Ausl matches 0 store success score VarLagerM.1Lager PZLagerM.1Ausl if data storage lagermaschine:v1daten "EigLagerM.1Lager"[0].tag
...
execute if score VarLagerM.1Ungleich PZLagerM.1Ausl matches 0 if score VarLagerM.1GUI PZLagerM.1Ausl matches 2 run data modify storage lagermaschine:v1daten "EigLagerM.1Vergleich" set from entity @s Items[{Slot:10b}].tag
execute if score VarLagerM.1Ungleich PZLagerM.1Ausl matches 0 if score VarLagerM.1GUI PZLagerM.1Ausl matches 2 store success score VarLagerM.1Ungleich PZLagerM.1Ausl run data modify storage lagermaschine:v1daten "EigLagerM.1Vergleich" set from storage lagermaschine:v1daten "EigLagerM.1Lager"[0].tag
