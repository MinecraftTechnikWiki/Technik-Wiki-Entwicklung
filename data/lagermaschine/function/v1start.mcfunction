...
give @a[distance=..15] minecraft:stick[minecraft:lore=["Wähle den Stock","in der Zweithand aus","um Gegenstände ins Lager","aufzufüllen oder zu leeren."],minecraft:custom_name={text:"Lager",color:"dark_purple",bold:true},minecraft:custom_data={EigLagerM.1Alle:true,EigLagerM.1Lager:true},minecraft:enchantment_glint_override=true]
