...
data modify entity @n[distance=..1,type=minecraft:item,tag=EtiLagerM.1Drop] Item.id set from storage lagermaschine:v1daten "EigLagerM.1Lager"[0].id
...
data merge entity @n[distance=..1,type=minecraft:item,tag=EtiLagerM.1Drop] {PickupDelay:0s}
