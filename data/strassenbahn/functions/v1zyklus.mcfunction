...
execute as @e[type=minecraft:armor_stand,tag=EtiStrasB.1Tram] at @s if entity @p[distance=..25,scores={PZStrasB.1Schl=1..},nbt={OnGround:true}] run function strassenbahn:v1bahn
