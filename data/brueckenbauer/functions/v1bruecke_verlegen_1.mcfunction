...
execute at @e[distance=..5,type=minecraft:armor_stand,tag=EtiBruB.1Gleisbett,sort=nearest,limit=2] align xyz positioned ~0.5 ~0.5 ~0.5 rotated ~ 0 run fill ^2 ^ ^1 ^-2 ^4 ^-4 minecraft:light_gray_stained_glass replace #brueckenbauer:v1berg_und_meeres_bloecke
...
execute if entity @s[scores={PZBruB.1Schl=14..}] run function brueckenbauer:v1bruecke_verlegen_2
